...
assert.equal(mod.PRODUCT_VERSION, '2.0.0')
assert.equal(mod.TOOL_NAMES.length, 7)
assert.deepEqual(mod.HARNESS_SKILLS, ['longpi-dispatch', 'longpi-board', 'longpi-boundary'])
