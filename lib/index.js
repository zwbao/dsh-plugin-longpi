...
function rangeProblem(spec, value, shown, raw) {
	...
	let message = `${spec.label_zh} 读成 ${withUnit(fmt$4(value), unit)}（${shown}），不在合理范围 ${withUnit(`${fmt$4(low)}–${fmt$4(high)}`, unit)} 内。`;
	if (raw != null) {
