	...
	factory: (require) => {
		...
		*/
		...
		function ConnectionStatus(props) {
			...
			return h$16("div", { className: "lp-conn-status" }, h$16("div", { className: "lp-status" }, h$16("span", {
				...
				"aria-hidden": true
			}), ok ? "已连接 Mirobody" : bad ? `连接失败：${connection.error || "没有返回原因"}` : "还没有连接 Mirobody"), connection.url_masked ? h$16("div", { className: "lp-caption lp-conn-url" }, h$16("code", null, connection.url_masked), sourceText(connection) ? ` · ${sourceText(connection)}` : "", connection.token_set ? " · 令牌已设置" : "") : null, ok && connection.summary ? h$16("div", { className: "lp-caption" }, `找到：${summaryParts(connection.summary).join(" · ")}`) : null);
		}
		...
		*/
		...
		function ConnectionPanel(props) {
			...
			return h$16("div", { className: "lp-conn" }, h$16(ConnectionStatus, { connection: data }), showForm ? h$16(ConnectionForm, {
				connection: data,
...
`;
		...
		*/
		...
		function Shell(props) {
			...
			})), h$1("span", { className: "lp-tool-title" }, props.title), props.summary != null ? h$1("span", { className: `lp-tool-summary ${props.tone ? `lp-tool-${props.tone}` : ""}` }, props.summary) : null, rawText ? h$1("button", {
				type: "button",
		...
		function CheckinToolView(props) {
			...
			}, !undone && undoable.length > 0 ? h$1("button", {
				type: "button",
				className: "lp-linkbtn",
				disabled: undoing,
				onClick: () => {
			...
			}, undoing ? "撤销中" : "撤销") : null, error ? h$1("span", { className: "lp-form-error" }, error) : null, ...problems.map((text) => h$1("p", {
				key: text,
				className: "lp-caption"
			}, text)));
		}
