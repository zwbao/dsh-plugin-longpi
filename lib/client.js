...
`;
		...
		function DashboardView() {
			...
			react.default.useEffect(() => {
				let cancelled = false;
				fetch("/api/longpi/dashboard").then(async (res) => {
