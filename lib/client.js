		...
		*/
		...
		function draftSource(args, data) {
			return {
				...
				markers: strings(args.markers)
			};
		}
		function DraftToolView(props) {
			const call = parseCall(props.block);
			const [saved, setSaved] = react.default.useState(() => adoptedOf(props.callId));
		...
		function CheckinToolView(props) {
			...
			return h$1(Shell, {
				...
				title: "打卡",
				quiet: true,
				summary: h$1("span", { className: `lp-chip-saved ${onlyTaken ? "lp-chip-undone" : ""}` }, h$1(Icon, {
