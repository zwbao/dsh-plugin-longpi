	...
	factory: (require) => {
		...
		*/
		...
		function Tooltip(props) {
			...
			return h$27("div", {
				...
				role: "status"
			}, h$27("div", { className: "lp-tip-title" }, tip.title), ...tip.rows.map((row, index) => h$27("div", {
				className: "lp-tip-row",
				key: index
			}, h$27("span", { className: "lp-tip-value" }, row.value), h$27("span", { className: "lp-tip-label" }, row.label))));
		}
		function LineChart(props) {
			...
			if (points.length === 0) return h$27("div", {
				ref,
			...
			return h$27("div", {
			...
			}, ...yTicks.map((value) => h$27("g", { key: `g${value}` }, h$27("line", {
				x1: pad.left,
				x2: width - pad.right,
				y1: y(value),
				y2: y(value),
				...
				className: "lp-axis",
				textAnchor: "end"
			}, fmt(value, value % 1 === 0 ? 0 : digits)))), props.band ? h$27("rect", {
				x: bandFrom,
				...
				className: "lp-band",
				rx: 3
			}) : null, props.reference ? h$27("g", null, h$27("line", {
				x1: pad.left,
				x2: width - pad.right,
				y1: y(props.reference.value),
				y2: y(props.reference.value),
				className: "lp-ref"
			}), props.compact ? null : h$27("text", {
				x: width - pad.right + 4,
				y: y(props.reference.value) + 3,
				className: "lp-axis"
			}, props.reference.label)) : null, props.goal != null ? h$27("g", null, h$27("line", {
				x1: pad.left,
				x2: width - pad.right,
				y1: y(props.goal),
				y2: y(props.goal),
			...
			}, `目标 ${fmt(props.goal, digits)}`)) : null, h$27("path", {
				d: area,
				className: "lp-area"
			}), h$27("path", {
				d: path,
				className: "lp-line"
			}), focus != null ? h$27("line", {
				x1: x(days[focus]),
				x2: x(days[focus]),
				y1: pad.top,
				y2: height - pad.bottom,
				className: "lp-cross"
			}) : null, ...points.map((point, index) => points.length > 24 && index !== points.length - 1 && index !== focus ? null : h$27("circle", {
				key: `p${index}`,
				cx: x(days[index]),
				cy: y(point.value),
				r: focus === index ? 5.5 : 4,
				...
				y: y(last.value) + 4,
				className: "lp-end"
			}, `${fmt(last.value, digits)}`), props.compact ? null : h$27("text", {
				x: pad.left,
				y: height - 6,
				className: "lp-axis"
			}, monthLabel(points[0]?.date ?? "")), props.compact || points.length < 2 ? null : h$27("text", {
				x: width - pad.right,
				y: height - 6,
				className: "lp-axis",
				textAnchor: "end"
			}, monthLabel(last.date))), h$27(Tooltip, {
				tip,
				width
			}));
		}
		function Timeline(props) {
			...
			return h$27("div", { className: "lp-timeline" }, h$27("div", {
				ref,
				className: "lp-chart",
				style: { height }
			}, h$27("svg", {
			...
			}, ...months.filter((_, index) => index % step === 0).map((iso) => h$27("g", { key: iso }, h$27("line", {
				x1: x(dayNumber(iso)),
				x2: x(dayNumber(iso)),
				y1: 20,
				y2: height - 6,
				...
				y: 12,
				className: "lp-axis"
			}, monthLabel(iso)))), ...props.checkups.map((iso) => h$27("g", { key: `c${iso}` }, h$27("line", {
				x1: x(dayNumber(iso)),
				x2: x(dayNumber(iso)),
				y1: 22,
				y2: height - 6,
				...
				}, item.title.length > 12 ? `${item.title.slice(0, 11)}…` : item.title), h$27("rect", {
					x: labelWidth,
					y: y0 - 12,
				...
				tip,
				width
			})), h$27("div", { className: "lp-legend-inline" }, h$27("span", { className: "lp-key-bar" }), "执行中", h$27("span", { className: "lp-key-dot" }), "体检日"));
		}
		function AdherenceStrip(props) {
			...
			}, ...props.calendar.map((day, index) => h$27("rect", {
				key: day.date,
		...
		function LeverBars(props) {
			...
			return h$27("div", {
				...
				return h$27("g", { key: item.label }, h$27("text", {
					x: 0,
					y: y0 + 14,
					className: "lp-row-label"
				}, item.label, item.detail ? h$27("tspan", {
					dx: 8,
					className: "lp-axis"
				}, item.detail) : null), h$27("path", {
		...
		function TableTwin(props) {
			return h$27("details", { className: "lp-twin" }, h$27("summary", null, "表格"), h$27("table", null, h$27("caption", null, props.caption), h$27("thead", null, h$27("tr", null, ...props.head.map((cell) => h$27("th", {
				key: cell,
				scope: "col"
			}, cell)))), h$27("tbody", null, ...props.rows.map((row, index) => h$27("tr", { key: index }, ...row.map((cell, column) => h$27("td", { key: column }, cell)))))));
		}
		//#endregion
		...
		*/
		...
		function VerdictChip(props) {
			...
			return h$26("span", { className: `lp-chip-v ${style.className}` }, h$26(Icon, {
				name: style.icon,
				size: 14
			}), label);
		}
		...
		*/
		function CheckChoices(props) {
			...
			if (state === null) return h$25("span", {
			...
			return h$25("span", {
				...
				role: "group",
				"aria-label": `${props.title}：今天`
			}, h$25("span", { className: `lp-choice-state ${state ? "lp-choice-state-done" : "lp-choice-state-missed"}` }, h$25(Icon, {
				name: state ? "check" : "close",
				size: 12,
				strokeWidth: 2
			}), state ? "已完成" : "没做到"), h$25("button", {
				type: "button",
		...
		function Section(props) {
			...
			}, h$24("div", { className: "lp-section-head" }, h$24("div", { className: "lp-section-titles" }, props.kicker ? h$24("div", { className: "lp-kicker" }, props.kicker) : null, h$24("h2", {
				className: "lp-h2",
				id: headingId
		...
		function Btn(props) {
			return h$24(_deepseek_ai_dsh_client_ui_primitives.Button, {
				variant: "primary",
				size: "md",
				...props
			});
		...
		function Segmented(props) {
			...
			return h$24("div", { className: "lp-seg-wrap" }, h$24("span", {
				id: labelId,
				className: props.hideLabel ? "lp-sr" : "lp-field-label"
			}, props.label), h$24("div", {
				className: "lp-seg",
				role: "radiogroup",
				"aria-labelledby": labelId
			}, ...props.options.map((option) => h$24("label", {
				key: option.value,
		...
		function Switch(props) {
			return h$24("button", {
				...
				"aria-hidden": true
			}, h$24("span", { className: "lp-switch-thumb" })), h$24("span", { className: "lp-switch-label" }, props.label));
		}
		...
		*/
		...
		function Tabs(props) {
			...
			}, ...props.tabs.map((tab, index) => h$24("button", {
				key: tab.key,
				type: "button",
				role: "tab",
			...
			}, tab.label, tab.badge ? h$24("span", { className: "lp-tab-badge" }, tab.badge) : null)));
		}
		...
		function LoadError(props) {
			...
			return h$24("div", {
				...
				name: "warn",
				size: 14
			}), h$24("span", { className: "lp-loaderror-text" }, `没有读到${props.what}${props.error ? `：${props.error}` : ""}。`), h$24("button", {
				type: "button",
				className: "lp-linkbtn",
				disabled: busy,
				onClick: () => {
		...
		function Goals(props) {
			...
			return h$23(Section, {
				...
				title: "如果达到目标",
				kicker: "模型估计"
			}, h$23("div", { className: "lp-grid-goals" }, pheno ? h$23("div", { className: "lp-card lp-model" }, h$23("div", { className: "lp-label" }, BIOAGE_LABEL, h$23(Info, { label: BIOAGE_LABEL }, BIOAGE_INFO)), pheno.goal ? h$23("div", { className: "lp-model-figures" }, h$23("div", null, h$23("div", { className: "lp-caption" }, "现在"), h$23("div", { className: "lp-tile-figure" }, `${fmt(pheno.now?.phenoage)} 岁`)), h$23(Icon, {
				name: "arrow",
				size: 18,
				className: "lp-muted-ink"
			}), h$23("div", null, h$23("div", { className: "lp-caption" }, "达到方案目标"), h$23("div", { className: "lp-tile-figure lp-good-ink" }, `${fmt(pheno.goal.phenoage)} 岁`)), h$23("span", { className: "lp-pill lp-pill-good" }, `${fmt(pheno.goal.phenoage_delta)} 岁`)) : h$23("p", { className: "lp-muted" }, pheno.note_zh ?? ""), leverRows.length > 0 ? h$23("div", null, h$23("div", { className: "lp-subhead" }, "每个目标单独的贡献"), h$23(LeverBars, { rows: leverRows })) : sensitivityRows.length > 0 ? h$23("div", null, h$23("div", { className: "lp-subhead" }, "对你的身体年龄影响最大的指标"), h$23(LeverBars, { rows: sensitivityRows })) : null, pheno.goal && pheno.now?.mortality_10y_pct != null && pheno.goal.mortality_10y_pct != null ? h$23("p", { className: "lp-fine" }, `同一模型的 10 年死亡风险：${pheno.now.mortality_10y_pct.toFixed(1)}% → ${pheno.goal.mortality_10y_pct.toFixed(1)}%。`) : null, h$23("p", { className: "lp-fine" }, `${pheno.measured_on ? `按 ${pheno.measured_on} 的血检计算。` : ""}${pheno.boundary_zh ?? ""}`)) : null, risk ? h$23("div", { className: "lp-card lp-model" }, h$23("div", { className: "lp-label" }, RISK_LABEL, h$23(Info, {
				label: RISK_LABEL,
				align: "end"
			}, RISK_INFO)), risk.status === "unavailable" ? h$23("div", null, h$23("div", { className: "lp-tile-figure lp-muted-ink" }, (risk.missing ?? []).length > 0 ? "还差几项" : "暂不显示"), h$23("p", { className: "lp-muted" }, risk.note_zh ?? "")) : h$23("div", null, h$23("div", { className: "lp-model-figures" }, h$23("div", null, h$23("div", { className: "lp-caption" }, "现在"), h$23("div", { className: "lp-tile-figure" }, risk.now?.risk_pct == null ? "—" : `${risk.now.risk_pct.toFixed(1)}%`), risk.category_zh?.now ? h$23("span", { className: "lp-pill" }, risk.category_zh.now) : null), risk.goal ? h$23(Icon, {
				name: "arrow",
				size: 18,
				className: "lp-muted-ink"
			}) : null, risk.goal ? h$23("div", null, h$23("div", { className: "lp-caption" }, "达到方案目标"), h$23("div", { className: "lp-tile-figure lp-good-ink" }, risk.goal.risk_pct == null ? "—" : `${risk.goal.risk_pct.toFixed(1)}%`), risk.category_zh?.goal ? h$23("span", { className: "lp-pill lp-pill-good" }, risk.category_zh.goal) : null) : null), (risk.levers ?? []).length > 0 ? h$23("div", null, h$23("div", { className: "lp-subhead" }, "每个目标单独的贡献"), h$23(LeverBars, { rows: (risk.levers ?? []).map((row) => ({
				label: row.label,
				detail: `${row.from} → ${row.to}`,
				value: row.years,
				unit: "个百分点"
			})) })) : h$23("p", { className: "lp-muted" }, risk.note_zh ?? "")), h$23("p", { className: "lp-fine" }, risk.boundary_zh ?? "")) : null, h$23("div", { className: "lp-card lp-model lp-model-note" }, h$23("div", { className: "lp-label" }, "关于“能多活几年”"), h$23("p", { className: "lp-muted" }, "没有经过验证的模型能对个人给出“多活几年”。这里只给有依据的模型估计：身体年龄、同一模型的 10 年死亡风险，以及中国人群的 10 年心血管风险。"), h$23("p", { className: "lp-fine" }, "试验里的平均效应都不大：热量限制使衰老速度慢约 2–3%，鱼油三年约慢 3 个月。能坚持的小改变，比追逐一个数字更重要。"))));
		}
		const STEP_ICON = {
			retest: "calendar",
		...
		function NextSteps(props) {
			...
			return h$23(Section, {
				...
				title: "下一步",
				kicker: "按优先级"
			}, h$23("ol", { className: "lp-card lp-steps" }, ...rows.map((row, index) => h$23("li", {
				key: index,
				className: `lp-step lp-step-${row.kind}`
			}, h$23("span", { className: "lp-step-icon" }, h$23(Icon, {
				name: STEP_ICON[row.kind] ?? "info",
				size: 15
			})), h$23("span", null, row.text_zh)))), h$23("p", { className: "lp-fine" }, "这里不会建议开始、停止或调整任何药物和补剂，也不给剂量。"));
		}
		//#endregion
		...
		*/
		...
		function EvidenceMore(props) {
			...
			return h$22("details", { className: "lp-evidence-more" }, h$22("summary", null, "证据"), evidence.population ? h$22("p", { className: "lp-caption" }, `试验人群：${evidence.population}`) : null, evidence.doi ? h$22("p", { className: "lp-caption" }, "文献：", h$22("a", {
				href: `https://doi.org/${evidence.doi}`,
				target: "_blank",
				rel: "noreferrer"
			}, `doi:${evidence.doi}`), evidence.verified ? "" : "（数据待核对）") : null, target ? h$22("p", { className: "lp-caption" }, targetText(target)) : null, h$22("p", { className: "lp-caption" }, "这是试验里的平均效果，个人结果会不同。"));
		}
		/** One line: what the trials found on average. */
		function EvidenceLine(props) {
			return h$22("p", { className: "lp-evidence" }, h$22(Icon, {
				name: "flask",
				size: 13
			}), h$22("span", null, props.item.evidence.expected_zh || "有研究证据支持"));
		}
		function DraftItemCard(props) {
			const item = props.item;
			return h$22("li", { className: `lp-draft-item ${props.compact ? "lp-draft-item-compact" : ""}` }, h$22("div", { className: "lp-draft-item-head" }, h$22("div", { className: "lp-draft-item-title" }, item.category_zh ? h$22("span", { className: "lp-cat" }, item.category_zh) : null, h$22("span", { className: "lp-strong" }, item.title), item.needs_doctor ? h$22("span", { className: "lp-warn-tag" }, h$22(Icon, {
				name: "warn",
				size: 12
			}), "需先与医生确认") : null), h$22("button", {
				type: "button",
				...
				name: "close",
				size: 12
			}), "去掉")), behaviorOf(item) ? h$22("p", { className: "lp-draft-detail" }, behaviorOf(item)) : null, h$22(EvidenceLine, { item }), item.cautions_zh.length > 0 ? h$22("div", { className: "lp-draft-warn" }, h$22(Icon, {
				name: "warn",
				size: 14,
				className: "lp-warn-icon"
			}), ...item.cautions_zh.map((text) => h$22("span", {
				key: text,
				className: "lp-warn-text"
			}, text))) : null, h$22(EvidenceMore, { item }));
		}
		...
		function DraftItems(props) {
			...
			return h$22("div", { className: "lp-draft-block" }, kept.length > 0 ? h$22("ul", { className: "lp-draft-items" }, ...kept.map((item) => h$22(DraftItemCard, {
				key: item.id,
				item,
				compact: props.compact,
				onRemove: () => props.onToggle(item.id)
			}))) : h$22("p", { className: "lp-muted" }, "所有项目都去掉了。恢复一项，或在对话里说说你想怎么调整。"), gone.length > 0 ? h$22("div", { className: "lp-draft-removed" }, h$22("span", { className: "lp-caption" }, "已去掉："), ...gone.map((item) => h$22("button", {
				key: item.id,
				type: "button",
				className: "lp-toggle",
		...
		function Priorities(props) {
			...
			return h$22("details", {
				...
				open: props.open
			}, h$22("summary", null, "为什么是这几项"), h$22("ol", { className: "lp-priorities" }, ...rows.map((row, index) => h$22("li", {
				key: `${row.marker_key}-${index}`,
				className: "lp-priority"
			}, h$22("div", { className: "lp-priority-head" }, h$22("span", { className: "lp-strong" }, row.label_zh), row.value != null ? h$22("span", { className: "lp-num" }, `${num(row.value)} ${row.unit}`) : null), h$22("div", { className: "lp-caption" }, [row.why_zh, row.date ? `${chineseDate(row.date)}的记录` : ""].filter(Boolean).join(" · "))))));
		}
		function DraftGoals(props) {
			if (props.goals.length === 0 && props.dropped === 0) return null;
			return h$22("details", { className: "lp-draft-more" }, h$22("summary", null, `目标（${props.goals.length} 个，按试验平均效应估算）`), props.goals.length > 0 ? h$22("ul", { className: "lp-rows lp-draft-goals" }, ...props.goals.map((goal) => h$22("li", {
				key: goal.marker,
				className: "lp-row"
			}, h$22("span", { className: "lp-row-main" }, h$22("span", { className: "lp-strong" }, goal.marker), h$22("span", { className: "lp-caption" }, `  ${goal.basis_zh}`)), h$22("span", { className: "lp-row-end lp-num" }, `${num(goal.value)} ${goal.unit}`)))) : null, props.dropped > 0 ? h$22("p", { className: "lp-fine" }, `去掉的项目对应的 ${props.dropped} 个目标也不会保存。`) : null);
		}
		...
		*/
		...
		function ConfirmModal(props) {
			...
			return h$22(_deepseek_ai_dsh_client_ui_primitives.Modal, {
				open: true,
				title: "采用这份方案",
				onClose: props.busy ? () => {} : props.onCancel,
				headless: true,
				className: "lp-confirm-dialog"
			}, h$22("div", { className: "lp lp-confirm" }, h$22("h2", { className: "lp-onb-title" }, "采用这份方案？"), h$22("p", { className: "lp-muted lp-confirm-lead" }, `保存为你的方案「${props.draft.title || "改善方案"}」，从今天（${chineseDate(props.today)}）开始。之后按项目打卡，并按每个指标安排复测；想调整随时在对话里说。`), h$22("ul", { className: "lp-confirm-list" }, ...props.items.map((item) => h$22("li", { key: item.id }, item.category_zh ? h$22("span", { className: "lp-cat" }, item.category_zh) : null, h$22("span", null, item.title), item.needs_doctor ? h$22("span", { className: "lp-warn-tag" }, "需先与医生确认") : null))), props.goals.length > 0 ? h$22("p", { className: "lp-caption" }, `目标：${props.goals.map((goal) => `${goal.marker} ${num(goal.value)} ${goal.unit}`).join("、")}（按试验平均效应估算，不是个人预测）`) : null, doctor.length > 0 ? h$22("p", { className: "lp-blocker lp-blocker-bad lp-confirm-doctor" }, `${doctor.map((item) => `「${item.title}」`).join("")}需先与医生确认后再开始。方案里不含任何剂量。`) : null, offer ? h$22("label", {
			...
			}), h$22("span", null, `每晚 ${offer.time} 提醒我打卡（不含健康数值）`)) : null, props.error ? h$22("p", {
				className: "lp-form-error",
				role: "alert"
			}, props.error) : null, h$22("div", { className: "lp-modal-actions" }, h$22(Btn, {
				variant: "outline",
		...
		*/
		...
		function Hint(props) {
			return h$22("span", { className: "lp-caption lp-draft-hint" }, "想调整？在对话中说", h$22("button", {
				type: "button",
		...
		function Draft(props) {
			...
			return h$22("div", { className: "lp-card lp-draft" }, h$22("div", { className: "lp-draft-head" }, h$22("div", null, h$22("div", { className: "lp-kicker" }, `方案草稿 · ${kept.length} 项 · 还没有保存`), h$22("h3", { className: "lp-h3 lp-draft-title" }, draft.title || "改善方案"), h$22("p", { className: "lp-muted" }, "按你的检查结果和试验证据起草。每项注明试验里的平均效果，个人结果会不同；你确认后才保存。")), h$22("span", { className: "lp-tag" }, "草稿")), h$22(DraftItems, {
				draft,
				removed,
				onToggle: toggle
			}), h$22(DraftGoals, {
			...
			}), h$22(Priorities, { brief: data.brief }), ...draft.notes_zh.map((text) => h$22("p", {
				key: text,
				className: "lp-fine"
			}, text)), h$22("div", { className: "lp-form-actions lp-draft-actions" }, h$22(Btn, {
				onClick: () => {
					setError(null);
					setConfirming(true);
				},
				disabled: kept.length === 0
			}, "采用这份方案"), h$22(Hint, { onPrompt: props.onPrompt })), h$22("p", { className: "lp-fine" }, data.brief.boundary_zh || "只起草生活方式；补剂只作为需先与医生确认的选项，不给剂量；不涉及任何处方药。"), confirming ? h$22(ConfirmModal, {
				draft,
				items: kept,
				goals,
		...
		function PlanDraftCard(props) {
			...
			if (!data && loading) return h$22("div", {
				className: "lp-card lp-draft",
				"aria-busy": true
			}, h$22("div", { className: "lp-kicker" }, "方案草稿"), h$22("p", { className: "lp-caption" }, "正在按你的结果和研究证据起草…"), h$22(Skeleton, { height: 72 }), h$22("div", { style: { height: 10 } }), h$22(Skeleton, { height: 72 }));
			if (!data) return h$22("div", { className: "lp-card lp-draft" }, h$22("div", { className: "lp-kicker" }, "方案草稿"), h$22("p", { className: "lp-muted" }, `没能读到方案草稿：${error ?? "没有返回"}。`), h$22("div", { className: "lp-form-actions" }, h$22(Hint, { onPrompt: props.onPrompt })));
			if (!data.draft) {
				...
				return h$22("div", { className: "lp-card lp-draft" }, h$22("div", { className: "lp-kicker" }, "方案草稿"), h$22("h3", { className: "lp-h3 lp-draft-title" }, "现在还起草不了方案"), h$22("p", { className: "lp-muted" }, reasons[0] || "你的记录里还没有能对上研究证据的指标。"), ...fine.map((text) => h$22("p", {
					key: text,
					className: "lp-fine"
				}, text)), h$22(Priorities, {
					brief: data.brief,
					open: true
				}), h$22("div", { className: "lp-form-actions lp-draft-actions" }, h$22(Hint, { onPrompt: props.onPrompt })));
			}
			return h$22(Draft, {
				data,
				draft: data.draft,
		...
		function TodayList(props) {
			...
			if (items.length === 0) return h$21("p", { className: "lp-muted" }, "今天没有需要打卡的项目，手环和 Mirobody 记录的会自动计入。");
			return h$21("ul", { className: "lp-today-list" }, ...items.map((row) => {
				const state = props.stateOf(row.id);
				return h$21("li", {
					key: row.id,
					className: `lp-today-row ${state === true ? "lp-today-done" : state === false ? "lp-today-missed" : ""}`
				}, h$21("span", { className: "lp-today-title" }, row.title), h$21(CheckChoices, {
					title: row.title,
					state,
		...
		function TodayTile(props) {
			...
			return h$21("div", { className: "lp-card lp-tile lp-tile-today" }, h$21("div", { className: "lp-tile-head" }, h$21("div", { className: "lp-label" }, "今天"), counts.total > 0 ? h$21("span", { className: "lp-caption" }, `${counts.done}/${counts.total} 完成`) : null), h$21(TodayList, props), h$21("p", { className: "lp-fine" }, "点错了可以撤销；没做到也记一下，执行率才真实。"));
		}
		function AdherenceTile(props) {
			...
			return h$21("div", { className: "lp-card lp-tile" }, h$21("div", { className: "lp-label" }, "方案执行"), h$21("div", { className: "lp-tile-row" }, h$21(Ring, {
				value: rate,
				label: "方案平均执行率",
				size: 56
			}), h$21("div", null, h$21("div", { className: "lp-tile-figure" }, rate == null ? "—" : `${Math.round(rate * 100)}%`), h$21("div", { className: "lp-caption" }, rate == null ? "还没有执行记录" : "近 12 周平均"))), streak > 1 ? h$21("div", { className: "lp-streak" }, h$21(Icon, {
				name: "flame",
				size: 15
			}), `连续 ${streak} 天`) : h$21("div", { className: "lp-caption lp-streak-empty" }, "连续完成两天以上会在这里显示"));
		}
		...
		function RetestTile(props) {
			...
			return h$21("div", { className: "lp-card lp-tile" }, h$21("div", { className: "lp-label" }, "下次复测"), now.length > 0 ? h$21("div", null, h$21("div", { className: "lp-tile-figure" }, "现在"), h$21("div", { className: "lp-caption" }, `可以复测${now.map((row) => row.marker).slice(0, 3).join("、")}`)) : first ? h$21("div", null, h$21("div", { className: "lp-tile-figure" }, `${daysBetween(props.today, first.date)} 天后`), h$21("div", { className: "lp-caption" }, `${chineseDate(first.date)}之后 · ${first.marker}`)) : h$21("div", null, h$21("div", { className: "lp-tile-figure lp-muted-ink" }, "—"), h$21("div", { className: "lp-caption" }, props.failed ? "复测日期没有读到" : "方案里的指标还没有排出复测日")), h$21("p", { className: "lp-fine" }, h$21(Icon, {
				name: "calendar",
				size: 13
			}), " 复测太早，变化多半只是波动。"));
		}
		...
		*/
		function Wins(props) {
			...
			if (wins.length === 0) return h$21("div", { className: "lp-card lp-wins lp-wins-empty" }, h$21("span", { className: "lp-win-icon lp-win-icon-quiet" }, h$21(Icon, {
				name: "spark",
				size: 16
			})), h$21("div", null, h$21("div", { className: "lp-strong" }, "还没有超出正常波动的变化"), h$21("div", { className: "lp-muted" }, "血脂、血糖、炎症指标通常要 1–3 个月才会动。坚持执行、按时复测，就是在积累证据。")));
			return h$21("div", { className: "lp-card lp-wins" }, h$21("div", { className: "lp-label" }, "朝目标方向、超出正常波动的变化"), ...wins.map(({ item, row }, index) => h$21("div", {
				className: "lp-win",
				key: index,
				style: { animationDelay: `${index * 80}ms` }
			}, h$21("span", { className: "lp-win-icon" }, h$21(Icon, {
				name: "check",
				size: 16
			})), h$21("div", null, h$21("div", { className: "lp-strong" }, `${row.marker} ${fmtAuto(row.baseline?.value)} → ${fmtAuto(row.followup?.value)} ${row.unit ?? ""}`), h$21("div", { className: "lp-muted" }, [
				`执行「${item.title}」期间`,
		...
		function ItemCard(props) {
			...
			return h$21("article", { className: "lp-card lp-item" }, h$21("div", { className: "lp-item-head" }, h$21("div", null, item.category_zh ? h$21("span", { className: "lp-cat" }, item.category_zh) : null, h$21("h3", { className: "lp-h3" }, item.title), h$21("div", { className: "lp-caption" }, `${item.start} 起 · 第 ${item.days ?? 0} 天`)), item.headline ? h$21(VerdictChip, { verdict: item.headline }) : null), h$21("div", { className: "lp-item-adherence" }, h$21("div", null, h$21("div", { className: "lp-caption" }, "近 12 周执行"), h$21("div", { className: "lp-item-figure" }, rate == null || adherence.level === "unknown" ? "记录不足" : `${Math.round(rate * 100)}%`), adherence.note_zh ? h$21("div", { className: "lp-fine lp-fine-tight" }, adherence.note_zh) : null), (adherence.calendar ?? []).length > 0 ? h$21(AdherenceStrip, {
				calendar: adherence.calendar ?? [],
				label: item.title
			}) : null), ...(item.verdicts ?? []).map((row, index) => h$21("div", {
				className: "lp-verdict",
				key: index
			}, h$21("div", { className: "lp-verdict-head" }, h$21(VerdictChip, { verdict: row.verdict }), h$21("span", { className: "lp-strong" }, row.marker), row.baseline && row.followup ? h$21("span", { className: "lp-num" }, `${fmtAuto(row.baseline.value)} → ${fmtAuto(row.followup.value)} ${row.unit ?? ""}${row.change ? `（${pct(row.change.pct)}）` : ""}`) : null), h$21("p", { className: "lp-reason" }, row.reason_zh ?? ""), (row.expected ?? []).length > 0 ? h$21("details", { className: "lp-expected" }, h$21("summary", null, "试验里平均能改变多少"), ...(row.expected ?? []).map((line) => h$21("p", {
				key: line.id,
				className: "lp-fine"
				...
				larger: "大于试验平均",
				opposite: "方向与试验相反"
			}[line.comparison] ?? ""}。` : "", ` doi:${line.doi}`))) : null)), h$21("div", { className: "lp-item-foot" }, idle ? h$21("span", { className: "lp-caption" }, idle) : source === "checkin" ? props.checkable ? h$21(react.default.Fragment, null, h$21("span", { className: "lp-caption" }, "今天"), h$21(CheckChoices, {
				title: item.title,
				state: props.state,
				busy: props.busy,
				onAnswer: (next) => props.onAnswer(item.id, item.title, next)
			})) : h$21("span", { className: "lp-caption" }, "今天不用打卡") : h$21("span", { className: "lp-caption" }, source === "wearable" ? "手环自动记录，不用打卡" : "服用情况在 Mirobody 里打卡")));
		}
		/** Stage plan, next to the draft: the person may bring their own plan instead. */
		function PlanStart(props) {
			return h$21("div", { className: "lp-card lp-plan-start" }, h$21("div", { className: "lp-plan-start-text" }, h$21("h3", { className: "lp-h3" }, "已经有自己的方案？"), h$21("p", { className: "lp-muted" }, "说出你的方案，或上传医生、长寿师给的方案。LongPi 会读给你确认后保存，再按每个指标安排复测日，并算出达到目标时的模型估计。"), h$21("p", { className: "lp-fine" }, "LongPi 只起草生活方式方案；不会开始、停止或调整任何处方药，也不给药物或补剂的剂量。")), h$21("div", { className: "lp-prompts" }, ...props.journey.suggestions.map((row) => h$21("button", {
				key: row.id,
				type: "button",
				className: "lp-prompt",
				onClick: () => props.onPrompt(row.text_zh)
			}, h$21("span", null, row.text_zh), h$21(Icon, {
				name: "arrow",
				size: 14
			})))));
		}
		function PlanSection(props) {
			...
			if (!props.journey.plan.exists && !tracking?.plan) return h$21(Section, {
				id: "lp-plan",
				title: "我的方案",
				kicker: "还没有方案"
			}, h$21(PlanDraftCard, {
			...
			if (props.loading && !tracking) return h$21(Section, {
				id: "lp-plan",
				title: props.journey.plan.title || "我的方案",
				kicker: "我的方案"
			}, h$21(Skeleton, { height: 260 }));
			...
			return h$21(Section, {
				...
				today,
				failed
			})), h$21(Wins, { tracking }), items.length > 0 ? h$21("div", { className: "lp-card lp-timeline-card" }, h$21("div", { className: "lp-label" }, "时间线"), h$21(Timeline, {
				...
				checkups,
				today
			})) : null, items.length > 0 ? h$21("div", { className: "lp-grid-items" }, ...items.map((item) => h$21(ItemCard, {
				key: item.id,
				item,
		...
		function PlanTab(props) {
			return h$21("div", { className: "lp-tab-body" }, h$21(PlanSection, props), h$21(Markers, { tracking: props.tracking }), h$21(Goals, { tracking: props.tracking }), h$21(NextSteps, { tracking: props.tracking }));
		}
		function Markers(props) {
			...
			return h$21(Section, {
			...
			}, h$21("div", { className: "lp-grid-charts" }, ...charts.map((chart) => {
				...
				return h$21("figure", {
					...
					key: chart.indicator
				}, h$21("div", { className: "lp-figure-head" }, h$21("figcaption", null, h$21("span", { className: "lp-strong" }, chart.label), h$21("span", { className: "lp-caption" }, ` ${chart.unit}`)), verdict ? h$21(VerdictChip, { verdict: verdict.verdict }) : null), h$21(LineChart, {
					points: chart.points,
					unit: chart.unit,
					label: chart.label,
					height: 150,
				...
				}), h$21("p", { className: "lp-fine" }, chart.band ? `浅色带：以 ${chart.band.base_date} 的 ${fmt(chart.band.base, 2)} 为基线的正常波动${chart.band.verified === false ? "（变异数据待核对）" : ""}。` : "缺少这项的个体变异数据，分不清真实变化和波动。"), h$21(TableTwin, {
		...
		*/
		...
		function RetestPart(props) {
			if (!props.text) return props.before ? h$20(Sep$1) : null;
			return h$20(react.default.Fragment, null, props.before ? h$20(Sep$1) : null, h$20("span", null, props.text), h$20(Sep$1));
		}
		...
		*/
		function CheckPill(props) {
			...
			return h$20("span", {
				...
				"aria-hidden": true
			}, state === true ? h$20(Icon, {
				name: "check",
				size: 10,
				strokeWidth: 2.4
			}) : state === false ? h$20(Icon, {
				name: "close",
				size: 9,
				strokeWidth: 2.4
			}) : null), props.title), open ? h$20("span", {
		...
		function RoutineRow(props) {
			...
			const lead = items.map((row) => h$20(CheckPill, {
				key: row.id,
				id: row.id,
				title: row.title,
			...
			if (items.length === 0 && journey.next.detail_zh) lead.push(h$20("span", { key: "next" }, journey.next.detail_zh));
			return h$20("div", {
				className: "lp lp-home-row",
				role: "group",
				"aria-label": "LongPi 今天"
			}, ...lead, reminder?.date ? h$20(RetestPart, {
			...
			}, "健康页 →"), h$20(Note, { text: error ?? props.note }));
		}
		...
		function HomeRow(props) {
			...
			if (journey.stage === "routine") return h$20(RoutineRow, {
				journey,
			...
			}, ...suggestions.map((row) => h$20("button", {
				key: row.id,
				type: "button",
				className: "lp-suggest",
				title: "放进输入框",
				onClick: () => setPendingPrompt(row.text_zh, "hero")
			}, row.text_zh)), h$20(Note, { text: note }));
		}
		//#endregion
		...
		*/
		...
		function Status(props) {
			...
			const parts = [];
			if (journey.stage === "consent" || journey.stage === "profile") parts.push("花 2 分钟建档，算出你的身体年龄和心血管风险", h$19(Sep, { key: "s" }), h$19(Go, {
				key: "go",
				label: "开始建档",
				onClick: open
			}));
			else if (journey.stage === "records") parts.push(journey.records.status === "error" ? "体检记录读取失败，暂时算不出结果" : "连接体检记录后，就能算出你的身体年龄", h$19(Sep, { key: "s" }), h$19(Go, {
				key: "go",
				...
				parts.push("还差 ", h$19("b", { key: "n" }, `${journey.addons.length} 项检查`), `就能算出${joinUnlocks(journey)}：${named}${more}`, h$19(Sep, { key: "s" }), h$19(Go, {
					key: "go",
					label: "加测清单",
					onClick: open
				}));
				...
				if (rows.length > 0) rows.forEach((row, index) => {
					if (index > 0) parts.push(h$19(Sep, { key: `s${index}` }));
					parts.push(h$19(react.default.Fragment, { key: `f${index}` }, ...row));
				});
				else {
					...
					else parts.push(detail, h$19(Sep, { key: "s" }), h$19(Go, {
						key: "go",
			...
			return h$19("p", { className: "lp-hero-status" }, ...parts);
		}
		/**
		...
		*/
		function ChangesLine$1(props) {
			...
			return h$19("p", { className: "lp-hero-changes" }, h$19(Icon, {
				name: "warn",
				size: 14,
				className: "lp-hero-changes-icon"
			}), `${subject}的变化超出正常波动`, h$19(Sep), h$19(Go, {
				label: "查看",
		...
		function Hero(props) {
			...
			return h$19("div", {
				...
				role: "group",
				"aria-label": "LongPi"
			}, h$19("div", { className: "lp-hero-title" }, h$19("span", {
				...
				size: 16,
				strokeWidth: 1.8
			})), h$19("span", null, titleOf(props.journey))), h$19(Status, {
				journey: props.journey,
				open: props.open
			}), h$19(ChangesLine$1, {
				journey: props.journey,
				openAt: props.openAt
			}), inline ? h$19("div", { className: "lp-hero-row" }, row) : null, host ? (0, react_dom.createPortal)(row, host) : null);
		}
		...
		function ConnectionStatus(props) {
			...
			return h$18("div", { className: "lp-conn-status" }, h$18("div", { className: "lp-status" }, h$18("span", {
				className: `lp-statusdot ${ok ? "lp-statusdot-on" : bad ? "lp-statusdot-bad" : ""}`,
				"aria-hidden": true
			}), ok ? "已连接 Mirobody" : bad ? `连接失败：${connection.error || "没有返回原因"}` : "还没有连接 Mirobody"), connection.url_masked ? h$18("div", { className: "lp-caption lp-conn-url" }, h$18("code", null, connection.url_masked), sourceText(connection) ? ` · ${sourceText(connection)}` : "", connection.token_set ? " · 令牌已设置" : "") : null, ok && connection.summary && !props.brief ? h$18("div", { className: "lp-caption" }, `找到：${summaryParts(connection.summary).join(" · ")}`) : null);
		}
		function TestOutcome(props) {
			const { result } = props;
			if (!result.ok) return h$18("p", {
				className: "lp-form-error",
				role: "alert"
			}, `连接没有成功：${result.error}`);
		...
		*/
		function ConnectionForm(props) {
			...
			return h$18("form", {
			...
			}, "Mirobody 地址", h$18("span", { className: "lp-optional" }, "在 Mirobody 网页生成的个人 MCP 地址")), h$18("input", {
			...
			}, "访问令牌", h$18("span", { className: "lp-optional" }, "选填：地址里已含令牌时留空")), h$18("input", {
				...
				className: "lp-form-error",
				role: "alert"
			}, error) : null, outcome ? h$18(TestOutcome, { result: outcome }) : null, h$18("div", { className: "lp-form-actions" }, h$18(Btn, {
				variant: "outline",
				type: "button",
				disabled: busy != null,
				onClick: () => {
			...
			}, busy === "test" ? "测试中…" : "测试连接"), h$18(Btn, {
				type: "submit",
				disabled: busy != null
			}, busy === "save" ? "测试并保存中…" : "保存"), saved ? h$18("button", {
				type: "button",
				className: "lp-linkbtn",
				disabled: busy != null,
				onClick: () => {
				...
				name: "trash",
				size: 13
			}), busy === "clear" ? "清除中" : "清除保存的地址") : null), h$18("p", { className: "lp-fine" }, saved ? "清除后改用安装时配置的地址（如果有）。" : "保存前会先用这个地址读一次记录目录，读到了才保存；地址和令牌只存在这台电脑上。"));
		}
		...
		function ConnectionPanel(props) {
			...
			const [open, setOpen] = react.default.useState(false);
			if (!data && loading) return h$18(Skeleton, { height: 96 });
			if (!data) return h$18(LoadError, {
				what: "连接状态",
				error,
			...
			return h$18("div", { className: "lp-conn" }, h$18(ConnectionStatus, {
				connection: data,
				brief: props.collapsed
			}), showForm ? h$18(ConnectionForm, {
				connection: data,
		...
		function SelfLatestList(props) {
			...
			if (rows.length === 0) return null;
			return h$17("ul", { className: "lp-self-latest" }, ...rows.map((row) => h$17("li", { key: row.key }, h$17("span", { className: "lp-caption" }, row.key === "sbp" ? "家庭血压" : row.label_zh), h$17("span", { className: "lp-self-value" }, selfLatestText(row, props.latest)), h$17("span", { className: "lp-caption" }, row.key === "sbp" ? `${row.n > 1 ? `7 天均值 · ${row.n} 次` : "1 次读数"} · 截至 ${chineseDate(row.date)}` : chineseDate(row.date)))));
		}
		...
		function UnitSelect(props) {
			...
			if (choices.length < 2) return h$17("span", { className: "lp-unit" }, props.spec.unit);
			return h$17("select", {
				id: props.id,
		...
		function SelfMeasureForm(props) {
			...
			const field = (key, placeholder) => h$17("div", { className: "lp-self-field" }, h$17("label", {
				className: "lp-field-label",
				htmlFor: `${props.idPrefix}-${key}`
			}, spec(key).label_zh), h$17("div", { className: "lp-input-unit" }, h$17("input", {
			...
			return h$17("form", {
				...
				noValidate: true
			}, h$17("div", { className: "lp-self-grid" }, field("waist", "例如 86"), field("weight", "例如 70.5"), h$17("div", { className: "lp-self-field lp-self-bp" }, h$17("span", {
				className: "lp-field-label",
			...
			}), h$17("span", { className: "lp-unit" }, "mmHg"))), h$17("div", { className: "lp-self-field" }, h$17("label", {
				className: "lp-field-label",
				...
				className: "lp-form-error",
				role: "alert"
			}, error) : null, h$17("div", { className: "lp-form-actions" }, h$17(Btn, {
				type: "submit",
				disabled: busy
			}, busy ? "记录中…" : "记录"), h$17("span", { className: "lp-caption" }, "单位可以选斤、尺或寸，会换算成 kg 和 cm。")));
		}
		function SelfRecent(props) {
			...
			if (!data && error) return h$17(LoadError, {
				what: "自测记录",
				error,
				compact: true,
				onRetry: () => reload("self")
			});
			if (rows.length === 0) return h$17("p", { className: "lp-caption lp-self-empty" }, "还没有自测记录。");
			...
			return h$17("div", { className: "lp-self-recent" }, h$17("div", { className: "lp-subhead" }, "最近记录"), h$17("ul", { className: "lp-rows" }, ...rows.map((row) => h$17("li", {
				key: row.id,
				className: "lp-row"
			}, h$17("span", { className: "lp-row-main" }, h$17("span", null, labelOf(row.key)), h$17("span", { className: "lp-num" }, ` ${fmt(row.value)} ${row.unit}`), row.given ? h$17("span", { className: "lp-caption" }, `（记为 ${fmt(row.given.value)} ${row.given.unit}）`) : null), h$17("span", { className: "lp-caption" }, chineseDate(row.date)), h$17("button", {
				type: "button",
		...
		function InlineSelf(props) {
			...
			}) : null, bp ? h$17("span", { className: "lp-unit" }, "mmHg") : h$17(UnitSelect, {
		...
		function ConsentText() {
			return h$16("div", { className: "lp-consent" }, ...CONSENT_SENTENCES.map((text, index) => h$16("div", {
				key: index,
		...
		function RecordsStatusLine(props) {
			...
			if (recordConnected(records.status)) {
				...
				return h$16("div", { className: "lp-status" }, h$16("span", {
		...
		function FoundTiles(props) {
			...
			return h$16("ul", { className: "lp-found" }, ...tiles.map((tile) => h$16("li", {
				key: tile.label,
				className: "lp-found-tile"
			}, h$16("span", { className: "lp-caption" }, tile.label), h$16("span", { className: "lp-found-figure" }, tile.figure, h$16("span", { className: "lp-bignum-unit" }, tile.unit)), tile.caption ? h$16("span", { className: "lp-caption" }, tile.caption) : null)));
		}
		...
		function ChangesLine(props) {
			...
			return h$16("p", { className: `lp-found-changes ${doctor ? "lp-found-changes-warn" : ""}` }, h$16(Icon, {
				name: doctor ? "warn" : "info",
				size: 14
			}), h$16("span", null, h$16("span", { className: "lp-strong" }, `值得注意：${rows.length} 项指标的变化超出正常波动`), ` · ${names}${rows.length > 3 ? " 等" : ""}`, props.onOpenChanges ? h$16(react.default.Fragment, null, " · ", h$16("button", {
				type: "button",
				className: "lp-row-link",
		...
		function RecordsStep(props) {
			...
			return h$16("div", { className: "lp-step-body" }, connected ? h$16(react.default.Fragment, null, h$16("p", { className: "lp-muted" }, "我们在 Mirobody 里看到了这些（只读）："), h$16(FoundTiles, { journey: props.journey }), records.status === "partial" ? h$16("p", { className: "lp-blocker lp-blocker-bad" }, `有一部分记录这次没有读到${records.read_errors[0] ? `：${records.read_errors[0]}` : ""}。它们不是“没测”，稍后在健康页刷新。`) : null, h$16(ChangesLine, props)) : h$16(react.default.Fragment, null, records.status === "error" ? h$16("p", { className: "lp-blocker lp-blocker-bad" }, `记录读取失败：${records.error || "没有返回原因"}`) : h$16("p", { className: "lp-muted" }, "LongPi 从你自己的 Mirobody 读取体检和可穿戴数据（只读）。在 Mirobody 网页生成个人 MCP 地址，粘贴到这里：")), h$16(ConnectionPanel, {
		...
		function ResultFigures(props) {
			...
			return h$16("div", { className: "lp-first" }, h$16("div", { className: "lp-first-cell" }, h$16("div", { className: "lp-caption" }, "身体年龄 · 模型估计"), bioage.status === "ok" ? h$16("div", null, h$16("div", { className: "lp-first-figure" }, fmt(bioage.phenoage), h$16("span", { className: "lp-bignum-unit" }, "岁")), h$16("div", { className: "lp-caption" }, versusAge(bioage.advance)), bioage.caveat_zh ? h$16("p", {
				className: "lp-caption lp-first-caveat",
				role: "note"
			}, bioage.caveat_zh) : null) : h$16("div", null, h$16("div", { className: "lp-first-wait" }, "还不能计算"), h$16("p", { className: "lp-blocker" }, bioage.blocker_zh))), h$16("div", { className: "lp-first-cell" }, h$16("div", { className: "lp-caption" }, "10 年心血管风险 · 模型估计"), risk.status === "ok" ? h$16("div", null, h$16("div", { className: "lp-first-figure" }, riskText(risk.risk_pct), h$16("span", { className: "lp-bignum-unit" }, "%")), h$16("div", { className: "lp-caption" }, risk.category_zh)) : h$16("div", null, h$16("div", { className: "lp-first-wait" }, "还不能计算"), h$16("p", { className: "lp-blocker" }, risk.blocker_zh))));
		}
		/**
		...
		*/
		function NowList(props) {
			...
			const rows = [];
			if (waist?.self_key) rows.push(h$16("li", {
				key: "self",
				className: "lp-now"
			}, h$16("span", {
				...
				name: "ruler",
				size: 15
			})), h$16("div", { className: "lp-now-text" }, h$16("div", { className: "lp-strong" }, `量一下${waist.item_zh}`), h$16("div", { className: "lp-caption" }, `填上就能算出${waist.unlocks_zh}`), h$16(InlineSelf, {
				journey,
			...
			rows.push(h$16("li", {
				...
				name: "spark",
				size: 15
			})), h$16("div", { className: "lp-now-text" }, h$16("div", { className: "lp-strong" }, "先制定一份改善方案"), h$16("div", { className: "lp-caption" }, "按你关心的方面，从收录的试验证据里起草；你确认后才保存。")), h$16(Btn, {
				size: "sm",
				variant: "outline",
				onClick: props.actions.onDraft
			}, "起草方案")));
			if (lab.length > 0) rows.push(h$16("li", {
				key: "lab",
				className: "lp-now"
			}, h$16("span", {
				className: "lp-now-icon",
				...
				name: "flask",
				size: 15
			})), h$16("div", { className: "lp-now-text" }, h$16("div", { className: "lp-strong" }, `下次体检加测${lab.slice(0, 2).map((row) => row.item_zh).join("、")}${lab.length > 2 ? " 等" : ""}`), h$16("div", { className: "lp-caption" }, `加上就能算${[...new Set(lab.map((row) => row.unlocks_zh))].join("、")}`)), h$16(Btn, {
				size: "sm",
				variant: "outline",
				onClick: props.actions.onAddons
			}, "加测清单")));
			return h$16("div", { className: "lp-now-block" }, h$16("div", { className: "lp-subhead" }, "现在就能做的事"), h$16("ul", { className: "lp-nows" }, ...rows));
		}
		...
		function FirstResult(props) {
			...
			return h$16("div", { className: "lp-step-body" }, h$16(ResultFigures, { journey: props.journey }), blocked ? h$16(NowList, props) : null);
		}
		//#endregion
		...
		function ProfileEditor(props) {
			...
			return h$15("form", {
				...
				noValidate: true
			}, onboarding ? null : h$15("div", { className: "lp-field" }, h$15("label", {
				className: "lp-field-label",
				htmlFor: `${props.idPrefix}-name`
			}, "称呼", h$15("span", { className: "lp-optional" }, "选填")), h$15("input", {
			...
			})), h$15("div", { className: "lp-profile-basics" }, h$15("div", { className: "lp-field lp-field-age" }, h$15("label", {
				className: "lp-field-label",
				htmlFor: `${props.idPrefix}-age`
			}, "实足年龄"), h$15("div", { className: "lp-input-unit" }, h$15("input", {
			...
			}), h$15("span", { className: "lp-unit" }, "岁"))), h$15("div", { className: "lp-field lp-field-sex" }, h$15(Segmented, {
			...
			}))), h$15("p", { className: "lp-unlock" }, h$15(Icon, {
				name: "lock",
				size: 12
			}), `解锁：${unlockOf(props.journey, "age")}`), h$15("fieldset", { className: "lp-facts" }, h$15("legend", { className: "lp-facts-legend" }, h$15("span", { className: "lp-strong" }, "心血管风险还需要这 6 项"), h$15("span", { className: "lp-caption" }, ` · 已回答 ${answeredFacts} 项，不确定就选“不确定”，不会当作“否”`)), ...facts.map((row) => h$15("div", {
				className: "lp-fact",
				key: row.key
			}, h$15("div", { className: "lp-fact-text" }, h$15("div", {
				className: "lp-fact-label",
				id: `${props.idPrefix}-${row.key}-text`
			}, row.label_zh), h$15("div", { className: "lp-unlock lp-unlock-inline" }, `解锁：${row.unlocks_zh || "心血管风险"}`, row.men_only ? female ? " · 女性的公式不用这一项，可以跳过" : " · 只用于男性的公式" : "")), h$15(Segmented, {
				...
				className: "lp-form-error",
				role: "alert"
			}, error) : null, h$15("div", { className: onboarding ? "lp-modal-actions" : "lp-form-actions" }, onboarding ? h$15(Btn, {
				variant: "outline",
				type: "button",
			...
			}, busy ? "保存中…" : onboarding ? "保存并继续" : "保存档案"), !onboarding && !dirty && props.journey?.profile.complete ? h$15("span", { className: "lp-caption" }, "已是最新") : null));
		}
		//#endregion
		...
		function Dots(props) {
			return h$14("div", { className: "lp-onb-progress" }, h$14("ol", {
				className: "lp-dots",
				"aria-hidden": true
			}, ...ONBOARDING_TITLES.map((_, index) => h$14("li", {
				key: index,
				className: `lp-dot-step ${index === props.step ? "lp-dot-now" : index < props.step ? "lp-dot-past" : ""}`
			}))), h$14("span", { className: "lp-caption" }, `第 ${props.step + 1} 步，共 ${ONBOARDING_TITLES.length} 步`));
		}
		...
		function ModelHint(props) {
			...
			return h$14("div", {
				...
				name: "info",
				size: 15
			}), h$14("span", null, "对话需要先在设置里填 DeepSeek API Key。"), props.onOpen ? h$14(Btn, {
				size: "sm",
				variant: "outline",
				onClick: props.onOpen
			}, "去设置") : h$14("span", { className: "lp-caption" }, "在左下角“设置 → 模型”中填写。"));
		}
		/** The journey did not arrive: say so, offer a retry, and let the person move on. */
		function NotRead(props) {
			return h$14(OnboardingModal, { title: "没有读到 LongPi 的数据" }, h$14("div", { className: "lp lp-onb" }, h$14("h2", {
				className: "lp-onb-title",
				tabIndex: -1
			}, "暂时没有读到 LongPi 的数据"), h$14("p", { className: "lp-muted" }, props.error ? `服务返回：${props.error}。通常是 DSH 刚启动、插件还在加载，稍等几秒再试。` : "读取比平时慢，可能是 DSH 刚启动或 Mirobody 响应慢。可以再试一次，或者先去对话，稍后在健康页继续。"), h$14("div", { className: "lp-modal-actions" }, h$14(Btn, {
				variant: "outline",
		...
		function Onboarding(props) {
			...
			return h$14(OnboardingModal, { title: ONBOARDING_TITLES[step] ?? ONBOARDING_TITLES[0] }, h$14("div", {
				className: "lp lp-onb",
				ref: content
			}, h$14(Dots, { step }), h$14("h2", {
				className: "lp-onb-title",
				tabIndex: -1
			}, ONBOARDING_TITLES[step]), step === 0 ? h$14("div", { className: "lp-onb-body" }, h$14(ModelHint, { onOpen: toSettings }), h$14(ConsentText), error ? h$14("p", {
				className: "lp-form-error",
				role: "alert"
			}, error) : null, h$14("div", { className: "lp-modal-actions" }, h$14(Btn, {
				variant: "outline",
				onClick: finish,
				disabled: busy
			}, "以后再说"), h$14(Btn, {
			...
			}, busy ? "记录中…" : "开始"))) : null, step === 1 ? h$14("div", { className: "lp-onb-body" }, h$14("p", { className: "lp-onb-lead" }, "只问能解锁结果的问题。每一项都可以跳过，跳过就是“不知道”，不会当作“否”。"), h$14(ProfileEditor, {
				journey,
				variant: "onboarding",
				idPrefix: "lp-onb-profile",
				onSaved: () => go(2),
				onSkip: () => go(2)
			})) : null, step === 2 ? h$14("div", { className: "lp-onb-body" }, h$14(RecordsStep, {
				journey,
				onOpenChanges: props.openPage || props.explicit ? () => toPage({
					tab: "overview",
					id: "lp-changes"
				}) : void 0
			}), h$14("div", { className: "lp-modal-actions" }, h$14(Btn, {
				variant: "outline",
				onClick: () => go(1)
			}, "上一步"), h$14(Btn, {
				"data-modal-autofocus": true,
				onClick: () => go(3)
			}, recordConnected(journey.records.status) ? "继续" : "先跳过"))) : null, step === 3 ? h$14("div", { className: "lp-onb-body" }, computing ? h$14("div", {
				className: "lp-onb-computing",
				"aria-busy": true
			}, h$14(Skeleton, { height: 88 }), h$14("p", { className: "lp-caption" }, "正在用你的记录计算…")) : h$14(FirstResult, {
				journey,
				onNotice: notify,
				actions: {
					onDraft: () => {
			...
			}), notice, h$14("p", { className: "lp-fine" }, journey.boundary_zh), h$14("div", { className: "lp-modal-actions" }, h$14(Btn, {
				variant: "outline",
				onClick: finish
			}, "完成"), props.explicit ? null : h$14(Btn, {
				"data-modal-autofocus": true,
				onClick: () => {
					props.openPage?.();
					finish();
		...
		function Spark(props) {
			...
			return h$13("div", { className: "lp-change-spark" }, h$13(LineChart, {
				points: row.points,
				unit: row.unit,
				label: row.label_zh,
				height: 56,
		...
		function ChangeChip(props) {
			...
			return h$13("span", { className: `lp-chip-c lp-chip-c-${tone}` }, h$13(Icon, {
		...
		function NotableRow(props) {
			const { row } = props;
			return h$13("li", { className: "lp-notable-row" }, h$13(ChangeChip, {
				verdict: row.verdict,
				askDoctor: row.ask_doctor
			}), h$13("span", { className: "lp-strong" }, row.label_zh), h$13("span", { className: "lp-num lp-notable-values" }, `${pairText(row.compare.from, row.compare.to)} ${prettyUnits(row.unit)}`.trim()), h$13(Spark, { row }));
		}
		...
		function Basis(props) {
			...
			return h$13("details", { className: "lp-basis" }, h$13("summary", null, "判断依据"), h$13("div", { className: "lp-change-notes" }, h$13("p", { className: "lp-caption" }, "“超出正常波动”指两次结果之差大于个体正常波动（参考变化值，RCV）。趋势图里的浅色带以比较起点那次结果为基线，落在带外就是真实变化。"), ...rows.map((row) => h$13("p", {
				key: `text:${row.key}`,
				className: "lp-caption"
			}, h$13("span", { className: "lp-strong" }, row.label_zh), `：${withoutLabel(row)}`)), ...caveats.map((text) => h$13("p", {
				key: `caveat:${text}`,
				className: "lp-caption"
			}, text)), unjudged.length > 0 ? h$13("p", { className: "lp-caption" }, `没有判断：${unjudged.map((row) => `${row.label_zh}（${row.reason_zh || "读取没有完成"}）`).join("、")}`) : null, sources.length > 0 ? h$13("p", { className: "lp-caption lp-change-source" }, "波动数据来源：", ...sources.flatMap((source, index) => [
				index > 0 ? "；" : null,
				source.url ? h$13("a", {
					key: source.url,
					href: source.url,
			...
			])) : null, props.journey.changes_note_zh ? h$13("p", { className: "lp-fine" }, props.journey.changes_note_zh) : null));
		}
		/**
		...
		*/
		function NotableChanges(props) {
			...
			}, h$13("div", { className: "lp-card-head" }, h$13("div", {
				className: "lp-label",
				id: "lp-changes-title"
			}, "值得注意的变化", rows.length > 0 ? h$13("span", { className: "lp-optional" }, `${rows.length} 项超出正常波动`) : null), h$13("button", {
				type: "button",
				className: "lp-row-link",
				onClick: props.onOpenIndicators
			}, "在“指标”里看全部 →")), ...advice.map((group) => h$13("p", {
				key: group.advice,
				className: "lp-change-advice lp-change-warn"
			}, h$13(Icon, {
				name: "warn",
				size: 14
			}), h$13("span", null, group.advice))), shown.length > 0 ? h$13("ul", { className: "lp-notable-list" }, ...shown.map((row) => h$13(NotableRow, {
				key: row.key,
				row
			}))) : h$13("p", { className: "lp-muted" }, "没有超出正常波动的变化。"), h$13(Basis, {
				journey: props.journey,
				rows
			}));
		}
		...
		function Sparkline(props) {
			const points = props.points;
			if (points.length < 2) return h$12("span", {
		...
		function JudgedChip(props) {
			const { row } = props;
			if (row.judged === "changed" && row.change) return h$12(ChangeChip, {
				verdict: row.change.verdict,
				askDoctor: row.change.ask_doctor
			});
			if (row.judged === "within") return h$12("span", { className: "lp-chip-c lp-chip-c-within" }, h$12(Icon, {
				name: "within",
				size: 12
			}), "波动内");
		...
		function IndicatorLine(props) {
			...
			return h$12("li", { className: `lp-ind-row ${props.open ? "lp-ind-open" : ""} ${row.read_error ? "lp-ind-failed" : ""}` }, h$12("button", {
				type: "button",
				className: "lp-ind-btn",
				"aria-expanded": props.open,
				"aria-controls": panelId,
				onClick: props.onToggle
			}, h$12("span", { className: "lp-ind-name" }, h$12("span", { className: "lp-strong" }, row.label_zh), row.plan_marker ? h$12("span", { className: "lp-tag lp-tag-plan" }, "方案") : null), row.read_error ? h$12("span", { className: "lp-ind-error" }, h$12(Icon, {
				name: "warn",
				size: 13
			}), `没有读到：${row.read_error}`) : h$12("span", { className: "lp-ind-value" }, h$12("span", { className: "lp-num" }, latestText(row)), row.latest?.text ? null : h$12("span", { className: "lp-caption" }, ` ${prettyUnits(row.unit)}`), row.latest ? h$12("span", { className: "lp-caption lp-ind-date" }, row.latest.date) : null), row.read_error ? h$12("span", { className: "lp-ind-spark" }) : h$12("span", { className: "lp-ind-spark" }, h$12(Sparkline, {
				points: row.points,
				label: row.label_zh
			})), h$12("span", { className: "lp-ind-judged" }, h$12(JudgedChip, { row })), h$12("span", { className: "lp-ind-source lp-caption" }, SOURCE_ZH[row.source]), h$12(Icon, {
				name: "chevron",
				size: 14,
				className: "lp-ind-chevron"
			})), props.open ? h$12(DetailPanel, {
				row,
				id: panelId
			}) : null);
		}
		function DetailPanel(props) {
			...
			const body = state.loading && !state.detail ? h$12(Skeleton, { height: 120 }) : !state.detail ? h$12(LoadError, {
				what: `${props.row.label_zh}的历次数值`,
				error: state.error,
				compact: true,
				onRetry: () => setAttempt((count) => count + 1)
			}) : h$12(DetailBody, { detail: state.detail });
			return h$12("div", {
		...
		function DetailBody(props) {
			...
			return h$12("div", { className: "lp-ind-detail" }, row.read_error ? h$12("p", { className: "lp-blocker lp-blocker-bad" }, `这项这次没有读到：${row.read_error}。下面是能读到的部分。`) : null, row.change?.text_zh ? h$12("p", { className: "lp-muted" }, prettyUnits(row.change.text_zh)) : null, numeric.length > 1 && units.length <= 1 ? h$12(LineChart, {
				...
				height: 150,
				digits
			}) : null, biovar ? h$12("p", { className: "lp-caption" }, `正常波动：+${fmt(biovar.band_pct.up, 1)}% / ${fmt(biovar.band_pct.down, 1)}%（个体内变异 ${fmt(biovar.cvi_pct, 1)}%）。两次结果之差在这个范围内，多半是测量和生理波动。`, biovar.source.url ? h$12(react.default.Fragment, null, " 来源：", h$12("a", {
				href: biovar.source.url,
				target: "_blank",
				rel: "noopener noreferrer"
			}, biovar.source.title || biovar.source.url)) : biovar.source.title ? ` 来源：${biovar.source.title}` : "", biovar.source.doi ? ` · doi:${biovar.source.doi}` : "") : h$12("p", { className: "lp-caption" }, row.source === "checkup" ? "这项没有收录个体正常波动数据，分不清真实变化和波动，所以不作判断。" : "手环和自测数据按周均值或日值显示趋势，不作正常波动判断。"), biovar?.caveat_zh ? h$12("p", { className: "lp-caption" }, biovar.caveat_zh) : null, points.length > 0 ? h$12("table", { className: "lp-ind-table" }, h$12("caption", { className: "lp-sr" }, `${row.label_zh}历次数值`), h$12("thead", null, h$12("tr", null, ...[
				"日期",
				"数值",
				"单位",
				"来自"
				...
				key: cell,
				scope: "col"
			}, cell)))), h$12("tbody", null, ...[...points].reverse().map((point, index) => h$12("tr", { key: `${point.date}-${index}` }, h$12("td", null, point.date), h$12("td", { className: "lp-num" }, point.text ?? (point.value == null ? "—" : fmt(point.value, digits))), h$12("td", null, prettyUnits(point.unit)), h$12("td", { className: "lp-caption" }, point.file ?? SOURCE_ZH[row.source]))))) : h$12("p", { className: "lp-muted" }, "没有可显示的数值。"), numeric.length > 1 && units.length > 1 ? h$12(TableTwin, {
		...
		function Loading$1() {
			return h$12("div", {
				...
				height: 32,
				width: 320
			}), h$12("div", { className: "lp-card" }, ...[
				0,
				1,
				2,
				3,
				4
			].map((index) => h$12(Skeleton, {
				key: index,
				height: 28,
		...
		function Empty(props) {
			...
			return h$12("div", { className: "lp-card lp-empty" }, h$12(Icon, {
				name: "flask",
				size: 18
			}), h$12("div", null, h$12("div", { className: "lp-strong" }, none ? "还没有连接体检记录" : "记录里还没有指标"), h$12("p", { className: "lp-muted" }, none ? "连接你的 Mirobody 之后，这里会列出每一次体检的化验值和手环数据，按系统分组，带趋势和正常波动的判断。" : "已连接 Mirobody，但还没有读到体检或手环数据。在 Mirobody 上传体检报告后，点右上角的刷新。"), none ? h$12(Btn, {
				size: "sm",
		...
		function IndicatorsTab(props) {
			...
			if (!data && loading) return h$12(Loading$1);
			if (!data) return h$12("div", { className: "lp-tab-body" }, h$12(LoadError, {
				what: "指标",
				error,
				onRetry: () => reload("indicators")
			}));
			if (data.groups.length === 0) {
				if (data.record.status === "error") return h$12("div", { className: "lp-tab-body" }, h$12(LoadError, {
					what: "体检记录",
					error: data.record.error || null,
					onRetry: () => reload("indicators")
				}));
				return h$12("div", { className: "lp-tab-body" }, h$12(Empty, {
					data,
			...
			return h$12("div", { className: "lp-tab-body lp-indicators" }, data.record.status === "partial" || data.record.status === "error" ? h$12("p", {
				className: "lp-blocker lp-blocker-bad lp-partial",
				role: "note"
			}, h$12(Icon, {
				name: "warn",
				size: 14
			}), h$12("span", null, `有一部分记录这次没有读到${data.record.error ? `：${data.record.error}` : failed > 0 ? `（${failed} 项）` : ""}。标着“没有读到”的指标不是没测，稍后刷新再读。`)) : null, h$12("div", { className: "lp-ind-toolbar" }, h$12("div", {
				...
				}, row.label, h$12("span", { className: "lp-toggle-count" }, String(count)));
			})), h$12("span", { className: "lp-caption" }, checkup ? `最近一次体检 ${chineseDate(checkup)}` : "", h$12(Info, {
				label: "和正常波动比",
				align: "end"
			}, "“变好/变差”：最近两次体检之差超出个体正常波动（参考变化值 RCV，按生物学变异数据库计算）；“需结合参考范围”：变化超出波动，但好坏要看是否在参考范围内；“波动内”：差值在正常波动以内；“未判断”：只有一次结果、没有这项的波动数据，或这次没有读到。手环为每周均值，自测为每日值，只显示趋势。"))), groups.length === 0 ? h$12("div", { className: "lp-card lp-empty" }, h$12("p", { className: "lp-muted" }, `没有“${filter.label}”的指标。`), h$12("button", {
				type: "button",
				className: "lp-row-link",
				onClick: () => props.onFilter("all")
			}, "看全部 →")) : h$12("div", { className: "lp-card lp-ind-card" }, h$12("div", {
				className: "lp-ind-head",
				"aria-hidden": true
			}, h$12("span", null, "指标"), h$12("span", null, "最近一次"), h$12("span", null, "趋势"), h$12("span", null, "和正常波动比"), h$12("span", null, "来源")), ...groups.map((group) => h$12("section", {
				key: group.key,
				className: "lp-ind-group",
				"aria-label": group.label_zh
			}, h$12("h3", { className: "lp-ind-group-title" }, group.label_zh, h$12("span", { className: "lp-optional" }, `${group.indicators.length} 项`)), h$12("ul", { className: "lp-ind-list" }, ...group.indicators.map((row) => h$12(IndicatorLine, {
				key: row.id,
				row,
				open: open === row.id,
				onToggle: () => setOpen((current) => current === row.id ? null : row.id)
			})))))), h$12("p", { className: "lp-fine" }, "点任一行看历次数值、单位、来自哪份报告，以及正常波动的依据。这里只列出记录里的数值，不做诊断。"));
		}
		//#endregion
		...
		function CardHead(props) {
			return h$11("div", { className: "lp-result-head" }, h$11("div", { className: "lp-label" }, props.label, h$11(Info, { label: props.label }, props.info)), h$11(EstimateTag));
		}
		...
		function Blocked(props) {
			...
			return h$11("div", { className: "lp-card lp-result lp-result-blocked" }, h$11(CardHead, {
				label: props.label,
				info: props.info
			}), h$11("div", { className: "lp-result-wait" }, "还不能计算"), h$11("p", { className: "lp-blocker" }, props.blocker || "还缺少计算需要的信息。"), props.needs.length > 0 ? h$11("div", { className: "lp-needs" }, h$11("span", { className: "lp-caption" }, "还需要"), ...props.needs.slice(0, NEEDS_SHOWN).map((need) => h$11("span", {
				className: "lp-need",
				key: need
			}, need)), props.needs.length > NEEDS_SHOWN ? h$11("span", { className: "lp-caption" }, `等 ${props.needs.length} 项`) : null) : null, props.selfAddon && props.selfAddon.self_key && action?.target !== "profile" && action?.target !== "records" ? h$11("div", { className: "lp-result-self" }, h$11("div", { className: "lp-caption" }, `${props.selfAddon.item_zh}可以自己在家量，记下就能算：`), h$11(InlineSelf, {
				journey: props.journey,
				selfKey: props.selfAddon.self_key,
				idPrefix: `${props.idPrefix}-self`,
				onNotice: props.onNotice
			})) : action ? h$11("div", { className: "lp-result-action" }, h$11(Btn, {
				size: "sm",
				variant: "outline",
				onClick: () => props.onAction(action.target)
			}, action.label, h$11(Icon, {
				name: "arrow",
				size: 14
			}))) : null);
		}
		function BodyAgeCard(props) {
			...
			if (result.status !== "ok") return h$11(Blocked, {
				journey: props.journey,
				label: "身体年龄",
				info: BIOAGE_INFO,
			...
			const info = h$11(react.default.Fragment, null, h$11("span", { className: "lp-info-line" }, BIOAGE_INFO), band != null ? h$11("span", { className: "lp-info-line" }, `浅色带是第一次检查的个体正常波动（±${fmt(band)} 岁${partial ? `，未含${bio?.band_missing?.join("、")}` : ""}），落在带外才算真实变化。`) : null, date ? h$11("span", { className: "lp-info-line" }, `最近一次：${chineseDate(date)}体检，共 ${count} 次完整血检。`) : null);
			return h$11("div", { className: "lp-card lp-result" }, h$11(CardHead, {
				label: "身体年龄",
				info
			}), h$11("div", { className: "lp-result-figure" }, h$11("span", { className: "lp-bignum" }, fmt(phenoage)), h$11("span", { className: "lp-bignum-unit" }, "岁"), versus ? h$11("span", { className: `lp-pill ${advance != null && advance < -.5 ? "lp-pill-good" : ""}` }, versus) : null), result.caveat_zh ? h$11("p", {
				className: "lp-caveat",
				role: "note"
			}, h$11(Icon, {
				name: "warn",
				size: 14
			}), h$11("span", null, result.caveat_zh)) : null, points.length > 1 ? h$11(LineChart, {
			...
			}) : props.tracking == null ? h$11(Skeleton, { height: 40 }) : null, h$11("p", { className: "lp-caption" }, [
				count > 0 ? `${count} 次体检` : "",
		...
		function RiskCard(props) {
			...
			return h$11("div", { className: "lp-card lp-result" }, h$11(CardHead, {
				label: "10 年心血管风险",
				info: h$11(react.default.Fragment, null, h$11("span", { className: "lp-info-line" }, RISK_INFO), card?.note_zh ? h$11("span", { className: "lp-info-line" }, card.note_zh) : null)
			}), h$11("div", { className: "lp-result-figure" }, h$11("span", { className: "lp-bignum" }, riskText(result.risk_pct)), h$11("span", { className: "lp-bignum-unit" }, "%"), result.category_zh ? h$11("span", { className: "lp-pill" }, result.category_zh) : null), goal != null && Number.isFinite(goal) ? h$11("div", { className: "lp-result-goal" }, h$11("span", { className: "lp-caption" }, "达到方案目标约"), h$11("span", { className: "lp-strong" }, `${riskText(goal)}%`), card?.category_zh?.goal ? h$11("span", { className: "lp-pill lp-pill-good" }, card.category_zh.goal) : null) : null, h$11("p", { className: "lp-caption" }, [result.date ? `按 ${chineseDate(result.date)}的记录和你的档案计算` : "", "未来 10 年发生心梗、脑卒中等的估计概率"].filter(Boolean).join(" · ")));
		}
		function ResultsRow(props) {
			...
			const bio = h$11(BodyAgeCard, {
				key: "bio",
				...props
			});
			const risk = h$11(RiskCard, {
				key: "risk",
				...props
			});
			return h$11("div", {
		...
		function AddonList(props) {
			...
			if (addons.length === 0) return h$11("p", { className: "lp-muted" }, "没有需要加测的项目。");
			return h$11("ul", {
				className: "lp-addons",
				id: `${props.idPrefix}-addons`
			}, ...addons.map((row) => h$11("li", {
				key: row.item_zh,
				className: "lp-addon"
			}, h$11("span", {
				...
				size: 14
			})), h$11("div", { className: "lp-addon-text" }, h$11("div", { className: "lp-strong" }, row.item_zh), h$11("div", { className: "lp-caption" }, `解锁：${row.unlocks_zh}${row.self_measurable ? " · 可以自己在家量" : " · 下次体检加测"}`)), row.self_measurable && row.self_key ? h$11(InlineSelf, {
				journey: props.journey,
		...
		function WeekStrip(props) {
			...
			return h$10("div", { className: "lp-week" }, h$10("span", { className: "lp-caption" }, "本周"), h$10("ol", {
				className: "lp-week-cells",
				"aria-label": `近 7 天：${week.map((day) => `${chineseDate(day.date)}${DAY_ZH[day.state]}`).join("，")}`
			}, ...week.map((day) => h$10("li", {
				key: day.date,
				...
				"aria-hidden": true
			}, WEEK_ZH[(/* @__PURE__ */ new Date(`${day.date}T12:00:00Z`)).getUTCDay()])))), retestText ? h$10("span", { className: "lp-caption" }, `· ${retestText}`) : null);
		}
		function TodayCard(props) {
			...
			}, h$10("div", { className: "lp-card-head" }, h$10("div", {
				className: "lp-label",
				id: "lp-today-title"
			}, "今天", counts.total > 0 ? h$10("span", { className: "lp-optional" }, `${counts.done} / ${counts.total}`) : null), props.journey.plan.days != null ? h$10("span", { className: "lp-caption" }, `方案第 ${props.journey.plan.days} 天`) : null), h$10(TodayList, {
				journey: props.journey,
				stateOf,
				busy,
				onAnswer: answer
		...
		function NextCard(props) {
			...
			return h$10("section", {
				...
				"aria-label": "下一步"
			}, h$10("div", { className: "lp-next-text" }, h$10("div", { className: "lp-label" }, "下一步"), h$10("div", { className: "lp-strong" }, next.title_zh), next.detail_zh && next.detail_zh !== next.title_zh ? h$10("p", { className: "lp-muted" }, next.detail_zh) : null), cta ? h$10(Btn, {
				size: "sm",
				onClick: cta.run
			}, cta.label, h$10(Icon, {
				name: "arrow",
		...
		function PartialNote(props) {
			...
			return h$10("p", {
				...
				name: "warn",
				size: 14
			}), h$10("span", null, `有一部分记录这次没有读到${records.read_errors.length > 0 ? `（${records.read_errors.slice(0, 2).join("；")}）` : ""}。`, missing.length > 0 ? `没读到的指标：${missing.slice(0, 6).join("、")}${missing.length > 6 ? ` 等 ${missing.length} 项` : ""}。` : "", "它们不是“没测”，稍后点右上角的刷新再读一次。"));
		}
		function Overview(props) {
			const { journey } = props;
			return h$10("div", { className: "lp-tab-body lp-overview" }, h$10(PartialNote, { journey }), journey.plan.exists ? h$10(TodayCard, {
				journey,
				tracking: props.tracking,
				onNotice: props.onNotice
			}) : null, h$10(ResultsRow, {
				journey,
				tracking: props.tracking,
				onAction: props.onAction,
				onNotice: props.onNotice
			}), h$10(NextCard, props), h$10(NotableChanges, {
				journey,
		...
		function ConnectionCard(props) {
			...
			}, h$9("div", { className: "lp-card-head" }, h$9("div", { className: "lp-label" }, "数据连接"), openSettings ? h$9("button", {
				type: "button",
				className: "lp-row-link",
			...
			}, editing ? "收起" : "修改连接")), data ? h$9(ConnectionStatus, { connection: data }) : h$9(RecordsStatusLine, { journey: props.journey }), editing && !openSettings ? h$9(ConnectionForm, {
				connection: data,
				idPrefix: "lp-profile-conn",
				onSaved: () => setEditing(false)
			}) : null, openSettings ? null : h$9("p", { className: "lp-fine" }, "也可以在 DSH 左下角的“设置 → LongPi”中修改。"));
		}
		function ProfileTab(props) {
			const { journey } = props;
			const today = journey.today;
			return h$9("div", { className: "lp-tab-body" }, h$9(Section, {
				id: "lp-profile-section",
				title: "档案与自测",
				kicker: "只保存在这台电脑上"
			}, h$9("div", { className: "lp-grid-2 lp-grid-top" }, h$9("div", {
				className: "lp-card",
				id: "lp-profile-card"
			}, h$9("div", { className: "lp-label" }, "档案"), h$9(ProfileEditor, {
				journey,
				variant: "page",
				idPrefix: "lp-profile",
				onNotice: props.onNotice
				...
				className: "lp-card",
				id: "lp-self-card"
			}, h$9("div", { className: "lp-label" }, "自测", h$9("span", { className: "lp-optional" }, "腰围 · 家庭血压 · 体重")), h$9(SelfLatestList, { latest: journey.self.latest }), h$9(SelfMeasureForm, {
				journey,
				idPrefix: "lp-self",
				onNotice: props.onNotice
			}), h$9("p", { className: "lp-fine" }, "家庭血压按最近 7 天的平均值来判断（欧洲高血压学会的做法），单次读数只作参考。早晚各量一次、每次坐着休息 5 分钟后再量。"), h$9(SelfRecent, { onNotice: props.onNotice })))), journey.addons.length > 0 ? h$9("div", {
				className: "lp-card",
				id: "lp-addons-card"
			}, h$9("div", { className: "lp-label" }, "下次体检加测", h$9("span", { className: "lp-optional" }, `${journey.addons.length} 项，加上就能算出更多结果`)), h$9(AddonList, {
				journey,
				onNotice: props.onNotice,
				idPrefix: "lp-profile-addons"
			})) : null, h$9("div", { className: "lp-grid-2 lp-grid-top" }, h$9(ConnectionCard, { journey }), h$9("div", {
				className: "lp-card",
				id: "lp-export-card"
			}, h$9("div", { className: "lp-label" }, "导出"), h$9("p", { className: "lp-muted" }, "报告汇总档案、记录里的变化、身体年龄和方案，可以带给医生看；日历文件包含复测日期和每天的打卡提醒。"), h$9("div", { className: "lp-form-actions" }, h$9(LinkButton, {
				...
				icon: "calendar",
				download: "longpi.ics"
			}, "加入日历")), h$9("p", { className: "lp-fine" }, h$9(Icon, {
				name: "lock",
				size: 12
		...
		function Header(props) {
			...
			return h$8("header", { className: "lp-header" }, h$8("div", { className: "lp-header-text" }, h$8("div", { className: "lp-kicker" }, `LongPi${journey?.version ? ` ${journey.version}` : ""} · 健康`), h$8("h1", { className: "lp-h1" }, `${greeting(/* @__PURE__ */ new Date())}${name ? `，${name}` : ""}`), h$8("p", { className: "lp-lead" }, `${chineseDate(today)} ${weekday(today)}${plan}`), journey ? h$8(RecordsStatusLine, { journey }) : props.failed ? null : h$8(Skeleton, {
				height: 18,
				width: 240
			})), h$8("div", { className: "lp-actions" }, h$8("button", {
				type: "button",
				className: "lp-linkbtn",
		...
		function Banner(props) {
			...
			return h$8("button", {
				...
				name: "spark",
				size: 14
			}), h$8("span", null, `还差 ${banner.left} 步：${banner.title}`), h$8("span", { className: "lp-banner-go" }, "继续 →"));
		}
		function Loading() {
			return h$8("div", {
				...
				height: 36,
				width: 320
			}), h$8("div", { className: "lp-results" }, h$8(Skeleton, {
				height: 180,
		...
		function Failed(props) {
			return h$8("div", {
				...
				role: "alert"
			}, h$8("div", { className: "lp-strong" }, "LongPi 没有读到数据"), h$8("p", { className: "lp-muted" }, `服务返回：${props.error}。通常是 DSH 刚启动、插件还在加载，稍等几秒再试。`), h$8(Btn, {
				variant: "outline",
				size: "sm",
				onClick: props.onRetry
			}, h$8(Icon, {
		...
		*/
		...
		function LongPiPage(props) {
			...
			let body;
			if (!journey && loading) body = h$8(Loading);
			else if (!journey) body = h$8(Failed, {
				error: error ?? "没有返回",
				onRetry: () => {
					doRefresh();
				}
				...
				let panel;
				if (tab === "overview") panel = h$8(Overview, {
					journey,
				...
				else if (tab === "indicators") panel = h$8(IndicatorsTab, {
					filter,
					onFilter: setFilter,
					onConnect: () => goTab("profile", { id: "lp-connection-card" })
				});
				else if (tab === "plan") panel = h$8(PlanTab, {
					journey,
					tracking: tracking.data,
				...
				else panel = h$8(ProfileTab, {
					journey,
					onNotice: notify
				});
				body = h$8("div", { className: `lp-body ${refreshing ? "lp-refreshing" : ""}` }, h$8(Banner, {
					journey,
			...
			return h$8("div", {
				...
				ref: root
			}, h$8("div", { className: "lp-page" }, h$8(Header, {
				journey,
			...
			}), notice ? h$8("div", { className: "lp-notice-slot" }, notice) : null, body, h$8("footer", { className: "lp-footer" }, h$8("p", null, journey?.boundary_zh || "模型估计，不是诊断，也不是用药建议。紧急情况请拨打 120。"), h$8("p", { className: "lp-caption" }, "档案、方案、打卡和自测只保存在这台电脑上，病历在你自己的 Mirobody 中；对话内容会发送给 DSH 里配置的模型处理。"))), onboarding ? h$8(Onboarding, {
				explicit: true,
		...
		function HealthPane(props) {
			...
			let body;
			if (!journey && loading) body = h$7("div", {
			...
			else if (!journey) body = h$7("div", {
				className: "lp-card lp-failed",
				role: "alert"
			}, h$7("p", { className: "lp-muted" }, `没有读到数据：${error ?? "没有返回"}。`), h$7(Btn, {
				variant: "outline",
				size: "sm",
				onClick: () => {
					refresh(true);
			...
			return h$7("div", { className: "lp lp-pane" }, h$7("div", { className: "lp-pane-head" }, h$7("span", { className: "lp-label" }, h$7(Icon, {
				name: "health",
				size: 14
			}), PANE_TITLE), props.openPage ? h$7("button", {
				type: "button",
				className: "lp-row-link",
				onClick: props.openPage
			}, "打开健康页 →") : null), notice ? h$7("div", { className: "lp-notice-slot" }, notice) : null, body, h$7("p", { className: "lp-fine lp-pane-foot" }, journey?.boundary_zh || "模型估计，不是诊断，也不是用药建议。紧急情况请拨打 120。"));
		}
		//#endregion
		...
		function Pill(props) {
			...
			}, h$6("span", { className: "lp-pill-mark" }, h$6(Mark, { size: 14 })), h$6("span", null, "LongPi · 今天还有 ", h$6("span", { className: "lp-pill-count" }, open.length), " 项没打卡")), h$6("button", {
				type: "button",
				className: "lp-pill-x",
				"aria-label": "今天不再提醒",
				onClick: () => {
		...
		function ReminderPill(props) {
			return typeof props.usePanelInfo === "function" ? h$6(WithPanelInfo, {
				...props,
				usePanelInfo: props.usePanelInfo
			}) : h$6(WithoutPanelInfo, props);
		}
		//#endregion
		...
		function TimeField(props) {
			return h$5("div", { className: "lp-field" }, h$5("label", {
				className: "lp-field-label",
				htmlFor: props.id
			}, props.label, props.hint ? h$5("span", { className: "lp-optional" }, props.hint) : null), h$5("input", {
				id: props.id,
				type: "time",
		...
		function Log(props) {
			...
			return h$5("div", { className: "lp-followup-log" }, h$5("div", { className: "lp-subhead" }, "最近发送", h$5("span", { className: "lp-optional" }, rows.length > 0 ? `最近 ${rows.length} 条` : "")), rows.length === 0 ? h$5("p", { className: "lp-caption" }, "还没有发过提醒。") : h$5("ul", { className: "lp-rows" }, ...rows.map((row, index) => h$5("li", {
				key: `${row.at}-${index}`,
				className: "lp-row"
			}, h$5("span", { className: "lp-row-main" }, h$5("span", { className: "lp-num" }, whenText(row.at)), "  ", h$5("span", null, LOG_ZH[row.kind] ?? row.kind), row.error ? h$5("span", { className: "lp-caption" }, `  ${row.error}`) : null), h$5("span", { className: "lp-row-end" }, channelsText(row) ? h$5("span", { className: "lp-caption" }, channelsText(row)) : null, h$5("span", { className: `lp-sent ${row.ok ? "lp-sent-ok" : "lp-sent-bad"}` }, h$5(Icon, {
		...
		function TestResult(props) {
			...
			if (rows.length === 0) return h$5("span", {
				className: "lp-caption",
				role: "status"
		...
		function Settings(props) {
			...
			return h$5("div", { className: `lp-followup ${props.hideSwitch ? "" : "lp-card"}` }, props.hideSwitch ? null : h$5("div", { className: "lp-followup-head" }, h$5(Switch, {
				id: "lp-followup-on",
			...
			}), h$5("span", { className: "lp-caption" }, settings.enabled ? hasChannel ? nextLine(data) : "已开启，但还没有可用的渠道：打开桌面通知或填写 Webhook。" : "关闭时不会发送任何提醒。开启后按下面的时间提醒打卡、到期复测和每周小结。")), h$5("div", { className: "lp-grid-2 lp-followup-grid" }, h$5("fieldset", { className: "lp-fieldset" }, h$5("legend", { className: "lp-label" }, "什么时候"), h$5("div", { className: "lp-followup-times" }, h$5(TimeField, {
				id: "lp-fu-checkin",
				label: "打卡提醒",
				hint: "当天还有未完成时",
			...
			})), h$5("div", { className: "lp-field" }, h$5("label", {
				className: "lp-field-label",
				htmlFor: "lp-fu-weekly"
			}, "每周小结"), h$5("div", { className: "lp-input-unit" }, h$5("select", {
				id: "lp-fu-weekly",
				className: "lp-select lp-select-wide",
				value: form.weeklyDay,
				onChange: (event) => set("weeklyDay", event.target.value)
			}, h$5("option", { value: "0" }, "不发送"), ...DAYS.map((label, index) => h$5("option", {
				key: label,
				value: String(index + 1)
			}, label))), form.weeklyDay !== "0" ? h$5("input", {
				type: "time",
				className: "lp-input lp-input-time",
			...
			}) : null)), h$5("div", { className: "lp-field" }, h$5(Check, {
				id: "lp-fu-quiet",
				checked: form.quietOn,
				onChange: (checked) => set("quietOn", checked)
			}, "免打扰时段"), form.quietOn ? h$5("div", { className: "lp-input-unit" }, h$5("input", {
				type: "time",
				className: "lp-input lp-input-time",
			...
			}), h$5("span", { className: "lp-unit" }, "至"), h$5("input", {
				type: "time",
				className: "lp-input lp-input-time",
				value: form.quietEnd,
				"aria-label": "免打扰结束",
			...
			})) : null)), h$5("fieldset", { className: "lp-fieldset" }, h$5("legend", { className: "lp-label" }, "发到哪里"), h$5(Check, {
				id: "lp-fu-desktop",
				checked: form.desktop && data.platform_desktop,
				disabled: !data.platform_desktop,
				onChange: (checked) => set("desktop", checked)
			}, "桌面通知", h$5("span", { className: "lp-caption" }, data.platform_desktop ? "  这台电脑的系统通知" : "  这台电脑的系统不支持")), h$5("div", { className: "lp-field" }, h$5("label", {
				className: "lp-field-label",
				htmlFor: "lp-fu-kind"
			}, "Webhook 渠道", h$5("span", { className: "lp-optional" }, "可选：发到手机上的群机器人或 App")), h$5("select", {
				id: "lp-fu-kind",
				className: "lp-select lp-select-wide",
				value: form.kind,
			...
			}, h$5("option", { value: "" }, "不使用"), ...Object.keys(KIND_ZH).map((key) => h$5("option", {
				key,
				value: key
			}, KIND_ZH[key])))), kind ? h$5("div", { className: "lp-field" }, h$5("label", {
				className: "lp-field-label",
				htmlFor: "lp-fu-url"
			}, "地址", storedSame ? h$5("span", { className: "lp-optional" }, `已设置：${settings.webhook?.url_masked}`) : null), h$5("input", {
				id: "lp-fu-url",
				type: "url",
				className: "lp-input",
				value: form.url,
			...
			})) : null, kind && SIGNED.includes(kind) ? h$5("div", { className: "lp-field" }, h$5("label", {
				className: "lp-field-label",
				htmlFor: "lp-fu-secret"
			}, "签名密钥", h$5("span", { className: "lp-optional" }, "机器人开了“加签”才需要")), h$5("div", { className: "lp-input-unit" }, h$5("input", {
				id: "lp-fu-secret",
				type: "password",
				className: "lp-input",
				value: form.secret,
			...
			}), storedSame && settings.webhook?.secret_set && !form.clearSecret && !form.secret ? h$5("button", {
				type: "button",
				className: "lp-linkbtn",
				onClick: () => set("clearSecret", true)
			}, "清除") : null)) : null)), h$5("div", { className: "lp-followup-detail" }, h$5(Segmented, {
				name: "lp-fu-detail",
				label: "内容",
				value: form.detail,
			...
			}), h$5("p", { className: "lp-caption" }, form.detail === "minimal" ? "只发“今天还有 2 项待打卡”这类提示，不含项目名称和健康数值。" : "会带上方案项目名称、执行率和复测指标，发到你配置的渠道。")), error ? h$5("p", {
				className: "lp-form-error",
				role: "alert"
			}, error) : null, h$5("div", { className: "lp-form-actions" }, h$5(Btn, {
				onClick: () => {
					save();
				},
				disabled: !dirty || saving
			}, saving ? "保存中…" : "保存设置"), h$5(Btn, {
				variant: "outline",
				onClick: () => {
					sendTest();
				},
				...
				name: "send",
				size: 14
			}), testing ? "发送中…" : "发送测试"), dirty ? h$5("span", { className: "lp-caption" }, "有未保存的更改") : test ? h$5(TestResult, {
				result: test,
				kind: settings.webhook?.kind ?? null
			}) : null), h$5("p", { className: "lp-fine" }, FOLLOWUP_NOTE), h$5(Log, { rows: data.log }));
		}
		...
		*/
		function ReminderSwitch(props) {
			...
			return h$5("div", { className: "lp-remind" }, h$5("div", { className: "lp-remind-row" }, h$5(Switch, {
				id: "lp-remind-on",
				checked: settings.enabled,
				busy,
				disabled: busy,
			...
			})), h$5("p", { className: "lp-caption" }, settings.enabled ? `${switchCaption(data)}${hasChannel ? ` ${nextLine(data)}` : ""}` : `关闭时不会发送任何提醒。开启后：${switchCaption(data)}`), error ? h$5("p", {
				className: "lp-form-error",
				role: "alert"
			}, error) : null);
		}
		...
		function FollowupPanel(props) {
			...
			if (!data && loading) return h$5(Skeleton, { height: 88 });
			if (!data) return h$5(LoadError, {
				what: "随访设置",
				error,
				onRetry: () => reload("followup")
			});
			return h$5("div", { className: "lp-followup-panel" }, h$5(ReminderSwitch, {
				data,
				onNotice: props.onNotice
			}), h$5("details", { className: "lp-more" }, h$5("summary", null, "更多设置", h$5("span", { className: "lp-optional" }, "复测提醒、每周小结、免打扰、发到飞书或手机、内容详略")), h$5(Settings, {
				data,
				onNotice: props.onNotice,
				hideSwitch: true
			})));
		...
		function MethodsSection(props) {
			...
			if (!board) return props.loading ? h$4(Skeleton, { height: 160 }) : h$4(LoadError, {
				what: "方法库",
				error: props.error,
			...
			return h$4("div", {
				...
				id: "lp-methods"
			}, h$4("p", { className: "lp-caption" }, `方法库 ${board.skills?.version ?? ""} · ${board.readiness?.declared ?? 0} 个个人方法。对话里照常可用。`), h$4("div", { className: "lp-grid-2" }, h$4(RunReady, {
				board,
				onNotice: props.onNotice
		...
		function Block(props) {
			return h$3("section", {
				...
				id: `${props.id}-title`
			}, props.title, props.hint ? h$3("span", { className: "lp-optional" }, props.hint) : null), props.children);
		}
		function Privacy() {
			return h$3("div", null, h$3("ul", { className: "lp-privacy" }, ...[
				[
					"lock",
					"存在哪里",
				...
				name: icon,
				size: 15
			})), h$3("div", null, h$3("div", { className: "lp-strong" }, title), h$3("p", { className: "lp-muted" }, text))))), h$3("div", { className: "lp-form-actions" }, h$3(LinkButton, {
				href: "/api/longpi/report",
				icon: "download",
		...
		function LongPiSettings(props) {
			...
			return h$3("div", { className: "lp lp-settings" }, h$3("div", { className: "lp-set-head" }, h$3("h2", { className: "lp-h2" }, "LongPi"), props.openPage ? h$3("button", {
				type: "button",
				className: "lp-row-link",
				onClick: () => {
					props.close?.();
			...
			}, "打开健康页 →") : null), notice ? h$3("div", { className: "lp-notice-slot" }, notice) : null, h$3(Block, {
				id: "lp-set-followup",
				title: "随访提醒",
				hint: "默认关闭 · 只在 DSH 运行时发送"
			}, h$3(FollowupPanel, { onNotice: notify })), h$3(Block, {
				id: "lp-set-connection",
				title: "数据连接",
				hint: "Mirobody"
			}, h$3(ConnectionPanel, { idPrefix: "lp-set-conn" })), h$3(Block, {
				id: "lp-set-privacy",
				title: "隐私与数据"
			}, h$3(Privacy)), h$3("section", {
				className: "lp-set-block",
				id: "lp-set-methods"
			}, h$3("details", {
				className: "lp-more",
				onToggle: (event) => setAdvanced(event.currentTarget.open)
			}, h$3("summary", null, h$3("span", { className: "lp-set-title" }, "高级：方法库"), h$3("span", { className: "lp-optional" }, "给想看方法细节的人")), advanced ? h$3(Methods, { onNotice: notify }) : null)));
		}
		//#endregion
...
`;
		...
		*/
		...
		function Shell(props) {
			...
			}, h$2("div", { className: "lp-tool-head" }, h$2("span", {
			...
			})), h$2("span", { className: "lp-tool-title" }, props.title), props.summary != null ? h$2("span", { className: `lp-tool-summary ${props.tone ? `lp-tool-${props.tone}` : ""}` }, props.summary) : null, props.action ?? null, rawText ? h$2("button", {
				type: "button",
			...
			})) : null), props.children ? h$2("div", { className: "lp-tool-body" }, props.children) : null, raw && rawText ? h$2("pre", { className: "lp-tool-raw" }, rawText) : null);
		}
		function DraftCard(props) {
			...
			if (saved) return h$2("div", { className: "lp-tool-saved" }, h$2("span", { className: "lp-chip-saved" }, h$2(Icon, {
				name: "check",
				size: 12,
				strokeWidth: 2
			}), `已保存为方案第 ${saved.version} 版`), saved.reminder ? h$2("span", { className: "lp-caption" }, `打卡提醒没有打开：${saved.reminder}`) : null, openPlan ? h$2("button", {
				type: "button",
				className: "lp-row-link",
				onClick: openPlan
			}, "在健康页查看 →") : null);
			return h$2("div", { className: "lp-tool-draft" }, h$2(DraftItems, {
				draft,
				removed,
				onToggle: toggle,
				compact: true
			}), props.data.brief.notes_zh[0] ? h$2("p", { className: "lp-fine" }, props.data.brief.notes_zh[0]) : null, h$2("div", { className: "lp-form-actions" }, h$2(Btn, {
				size: "sm",
				onClick: () => {
					setError(null);
					setConfirming(true);
				...
				disabled: kept.length === 0
			}, "采用这份方案"), h$2("span", { className: "lp-caption" }, "每项是试验里的平均效果，个人结果会不同；补剂不给剂量，不涉及处方药。")), confirming ? h$2(ConfirmModal, {
				draft,
				items: kept,
				goals,
		...
		function DraftToolView(props) {
			...
			if (call.state === "running") return h$2(Shell, {
				call,
				icon: "spark",
				title: "起草方案",
				summary: "正在按你的结果和试验证据起草…"
			});
			if (call.state === "error") return h$2(Shell, {
				call,
				icon: "spark",
				title: "起草方案",
			...
			if (!data.draft) return h$2(Shell, {
				call,
				icon: "spark",
				title: "方案草稿",
				summary: "现在还起草不了"
			}, h$2("p", { className: "lp-muted" }, data.brief.notes_zh[0] || "记录里还没有能对上研究证据的指标。"));
			return h$2(Shell, {
				call,
				icon: "spark",
				title: "方案草稿",
		...
		function SaveToolView(props) {
			...
			if (result.saved === true) {
				...
				return h$2(Shell, {
					...
					title: "保存方案",
					quiet: true,
					summary: h$2("span", { className: "lp-chip-saved" }, h$2(Icon, {
						name: "check",
						size: 12,
						strokeWidth: 2
					}), version != null ? `已保存为方案第 ${version} 版` : "已保存"),
					action: openPlan ? h$2("button", {
						type: "button",
			...
			}, readBack.length > 0 ? h$2("ul", { className: "lp-readback" }, ...readBack.map((text, index) => {
				const row = readBackRow(text);
				return h$2("li", { key: index }, row.category ? h$2("span", { className: "lp-cat" }, row.category) : null, h$2("span", { className: "lp-strong" }, row.title), row.rest ? h$2("span", { className: "lp-caption" }, ` ${row.rest}`) : null);
			})) : null, ...errors.map((text) => h$2("p", {
				key: `e:${text}`,
				className: "lp-form-error"
			}, text)), ...warnings.map((text) => h$2("p", {
				key: `w:${text}`,
		...
		function CheckinToolView(props) {
			...
			if (entries.length === 0) return h$2(Shell, {
				call,
				icon: "check",
				title: "打卡",
				summary: "没有记下",
			...
			return h$2(Shell, {
				...
				title: "打卡",
				quiet: true,
				summary: h$2("span", { className: `lp-chip-saved ${onlyTaken ? "lp-chip-undone" : ""}` }, h$2(Icon, {
					name: onlyTaken ? "close" : "check",
					size: 12,
					strokeWidth: 2
				}), parts.join("；")),
				action: !undone && undoable.length > 0 ? h$2("button", {
					type: "button",
					className: "lp-tool-undo",
					disabled: undoing,
					onClick: () => {
			...
			}, error ? h$2("p", { className: "lp-form-error" }, error) : null, ...problems.map((text) => h$2("p", {
				key: text,
				className: "lp-caption"
			}, text)));
		}
		...
		function ResultFigure(props) {
			return h$2("div", { className: "lp-tool-result" }, h$2("span", { className: "lp-tool-figure" }, props.figure, h$2("span", { className: "lp-bignum-unit" }, props.unit)), h$2("span", {
				className: "lp-tag",
				title: "模型根据你的记录计算的估计值，不是诊断"
			}, "模型估计"), h$2(Info, { label: props.label }, props.info), ...props.lines.filter(Boolean).map((line) => h$2("span", {
				key: line,
				className: "lp-caption"
			}, line)));
		}
		function SkillToolView(props) {
			...
			if (name === PHENOAGE_SKILL) {
				...
				if (phenoage != null) return h$2(Shell, {
					call,
					icon: "play",
					title: BIOAGE_LABEL,
			...
			return h$2(Shell, {
				...
				title: plain,
				summary: "已算出"
			}, excerpt ? h$2("details", { className: "lp-tool-report" }, h$2("summary", null, "报告"), h$2("pre", null, excerpt)) : null);
		}
		function SituationToolView(props) {
			...
			return h$2(Shell, {
				...
				quiet: true
			}, failed ? h$2("p", { className: "lp-caption lp-tool-warn" }, h$2(Icon, {
				name: "warn",
				size: 12
			}), ` 有一部分记录没有读到${typeof result.record_error === "string" && result.record_error ? `：${result.record_error}` : ""}`) : null, changes.length > 0 ? h$2("p", { className: "lp-tool-doctor" }, h$2(Icon, {
				name: "warn",
				size: 13
