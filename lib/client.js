	...
	factory: (require) => {
		...
		*/
		...
		function FirstResult(props) {
			...
			return h$9("div", { className: "lp-step-body" }, !props.showResults && blocked === 0 ? h$9(CanCompute, { journey: props.journey }) : null, !props.showResults ? null : h$9("div", { className: "lp-first" }, h$9("div", { className: "lp-first-cell" }, h$9("div", { className: "lp-caption" }, "身体年龄 · 模型估计"), bioage.status === "ok" ? h$9("div", null, h$9("div", { className: "lp-first-figure" }, fmt(bioage.phenoage), h$9("span", { className: "lp-bignum-unit" }, "岁")), h$9("div", { className: "lp-caption" }, [versusAge(bioage.advance), bioage.band_years != null ? `正常波动 ±${fmt(bioage.band_years)} 岁` : ""].filter(Boolean).join(" · "))) : h$9("div", null, h$9("div", { className: "lp-first-wait" }, "还不能计算"), h$9("p", { className: "lp-blocker" }, bioage.blocker_zh))), h$9("div", { className: "lp-first-cell" }, h$9("div", { className: "lp-caption" }, "10 年心血管病风险 · 模型估计"), risk.status === "ok" ? h$9("div", null, h$9("div", { className: "lp-first-figure" }, riskText(risk.risk_pct), h$9("span", { className: "lp-bignum-unit" }, "%")), h$9("div", { className: "lp-caption" }, [risk.category_zh, "China-PAR"].filter(Boolean).join(" · "))) : h$9("div", null, h$9("div", { className: "lp-first-wait" }, "还不能计算"), h$9("p", { className: "lp-blocker" }, risk.blocker_zh)))), blocked > 0 ? h$9("div", { className: "lp-first-addons" }, h$9("div", { className: "lp-subhead" }, `还差 ${blocked} 项检查`, h$9("span", { className: "lp-optional" }, "下次体检加测，或现在自己量")), h$9(AddonList, {
				journey: props.journey,
				onNotice: props.onNotice,
